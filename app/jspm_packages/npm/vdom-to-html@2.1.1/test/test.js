...
describe('toHTML()', function() {
  ...
  it('should render any attributes', function() {
    var node = new VNode('circle', {attributes: {
        cx: "60",
        cy: "60",
        r: "50"
      }});
  ...
  it('should render nested children', function() {
    var node = new VNode('div', null, [new VNode('div', {id: 'a-div'}, [new VNode('div', null, [new VText('HI!')])]), new VNode('div', {className: 'just-another-div'})]);
  ...
  it('should not encode script tag contents, when using hyperscript', function() {
    var node = h('div', null, [h('script', null, 'console.log("zzz");')]);
    assert.equal(toHTML(node), '<div><script>console.log("zzz");</script></div>');
  });
