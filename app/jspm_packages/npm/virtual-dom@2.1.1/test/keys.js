...
test("mix keys without keys", function(assert) {
  var leftNode = h("div", [h("div", {key: 1}), h("div"), h("div"), h("div"), h("div"), h("div"), h("div"), h("div")]);
  var rightNode = h("div", [h("div"), h("div"), h("div"), h("div"), h("div"), h("div"), h("div"), h("div", {key: 1})]);
  var rootNode = render(leftNode);
...
test("avoid unnecessary reordering", function(assert) {
  var leftNode = h("div", [h("div"), h("div", {key: 1}), h("div")]);
  var rightNode = h("div", [h("div"), h("div", {key: 1}), h("div")]);
  var rootNode = render(leftNode);
  var childNodes = childNodesArray(rootNode);
  var patches = diff(leftNode, rightNode);
...
test("missing key gets replaced", function(assert) {
  var leftNode = h("div", [h("div", {key: 1}), h("div"), h("div"), h("div"), h("div"), h("div"), h("div"), h("div")]);
  var rightNode = h("div", [h("div"), h("div"), h("div"), h("div"), h("div"), h("div"), h("div"), h("div")]);
  var rootNode = render(leftNode);
  var childNodes = [];
  for (var i = 0; i < rootNode.childNodes.length; i++) {
    childNodes.push(rootNode.childNodes[i]);
...
test("widgets can be keyed", function(assert) {
  ...
  var leftNode = h("div", [new DivWidget("1", "a"), new DivWidget("2", "b"), new DivWidget("3", "c")]);
  var rightNode = h("div", [new DivWidget("3", "c"), new DivWidget("2", "b"), new DivWidget("1", "a")]);
  var rootNode = render(leftNode);
  var childNodes = childNodesArray(rootNode);
  var patches = diff(leftNode, rightNode);
  assert.equal(patchCount(patches), 4);
  var newRoot = patch(rootNode, patches);
  assert.equal(newRoot, rootNode);
  assert.equal(newRoot.childNodes.length, rootNode.childNodes.length);
...
test("delete key at the start", function(assert) {
  var leftNode = h("div", [h("div", {key: "a"}, "a"), h("div", {key: "b"}, "b"), h("div", {key: "c"}, "c")]);
  var rightNode = h("div", [h("div", {key: "b"}, "b"), h("div", {key: "c"}, "c")]);
  var rootNode = render(leftNode);
  var childNodes = childNodesArray(rootNode);
  var patches = diff(leftNode, rightNode);
  assert.equal(patchCount(patches), 1);
...
test("add key to start", function(assert) {
  var leftNode = h("div", [h("div", {key: "b"}, "b"), h("div", {key: "c"}, "c")]);
  var rightNode = h("div", [h("div", {key: "a"}, "a"), h("div", {key: "b"}, "b"), h("div", {key: "c"}, "c")]);
  var rootNode = render(leftNode);
  var childNodes = childNodesArray(rootNode);
  var patches = diff(leftNode, rightNode);
  assert.equal(patchCount(patches), 1);
...
test("delete key at the end", function(assert) {
  var leftNode = h("div", [h("div", {key: "a"}, "a"), h("div", {key: "b"}, "b"), h("div", {key: "c"}, "c")]);
  var rightNode = h("div", [h("div", {key: "a"}, "a"), h("div", {key: "b"}, "b")]);
  var rootNode = render(leftNode);
  var childNodes = childNodesArray(rootNode);
  var patches = diff(leftNode, rightNode);
  assert.equal(patchCount(patches), 1);
...
test("add key to end", function(assert) {
  var leftNode = h("div", [h("div", {key: "a"}, "a"), h("div", {key: "b"}, "b")]);
  var rightNode = h("div", [h("div", {key: "a"}, "a"), h("div", {key: "b"}, "b"), h("div", {key: "c"}, "c")]);
  var rootNode = render(leftNode);
  var childNodes = childNodesArray(rootNode);
  var patches = diff(leftNode, rightNode);
...
test("add to front and remove", function(assert) {
  var leftNode = h("ul", [h("li", {key: "c"}, "c"), h("li", {key: "d"}, "d")]);
  var rightNode = h("ul", [h("li", {key: "a"}, "a"), h("li", {key: "b"}, "b"), h("li", {key: "c"}, "c"), h("li", {key: "e"}, "e")]);
  var rootNode = render(leftNode);
  var childNodes = childNodesArray(rootNode);
  var patches = diff(leftNode, rightNode);
  var newRoot = patch(rootNode, patches);
...
test("adding multiple widgets", function(assert) {
  ...
  var secondTree = h("div", [new FooWidget("foo")]);
  ...
  var thirdTree = h("div", [new FooWidget("foo"), new FooWidget("bar")]);
...
function keyTest(itemsA, itemsB) {
  test('keyTest([' + itemsA.join() + '], [' + itemsB.join() + '])', assertKeys);
