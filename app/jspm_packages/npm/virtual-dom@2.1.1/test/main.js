...
test("defaults to div when using selectors", function(assert) {
  ...
  assertNode(assert, node3, "DIV", {
    id: "important",
    className: "pretty"
  });
  assertNode(assert, node4, "DIV", {
    id: "important",
    className: "pretty"
  });
  assert.end();
...
test("children are added", function(assert) {
  var vdom = h("div", [h("div", ["just testing", "multiple", h("b", "nodes")]), "hello", h("span", "test")]);
  var dom = render(vdom);
...
test("incompatible children are ignored", function(assert) {
  var vdom = h("#important.pretty", {style: {"cssText": "color: red;"}}, [null]);
  var dom = render(vdom);
  assert.equal(dom.id, "important");
  assert.equal(dom.className, "pretty");
  assert.equal(dom.tagName, "DIV");
...
test("injected warning is used", function(assert) {
  var badObject = {};
  var vdom = h("#important.pretty", {style: {cssText: "color: red;"}});
...
test("Nested widget is initialised on render", function(assert) {
  ...
  var vdom = h("div", [h("span", "text"), h("div.widgetContainer", [Widget]), h("p", "more text")]);
...
test("Patch nested widgets", function(assert) {
  ...
  var leftTree = h("div", [h("span", "text"), h("div.widgetContainer", [leftWidget]), h("p", "more text")]);
  var rightTree = h("div", [h("span", "text"), h("div.widgetContainer", [rightWidget]), h("p", "more text")]);
  domNode = render(leftTree);
  assert.equal(initCount, 1, "initCount after left render");
  assert.equal(updateCount, 0, "updateCount after left render");
  var patches = diff(leftTree, rightTree);
...
test("Ensure children are not rendered more than once", function(assert) {
  ...
  Widget.prototype.type = "Widget";
  var rightWidget = new Widget(rightState);
  var leftTree = h("div.container", [h("div")]);
  var rightTree = h("div.container", [h("section.widgetContainer", rightWidget)]);
  domNode = render(leftTree);
...
test("Patching parent destroys stateful sibling", function(assert) {
  ...
  var deepTree = h("div", ["hello", h("span", "test"), h("div", [h("article", [statefulWidget])]), h("div", [h("div", "test")])]);
  var rootNode;
...
test("Destroy widget nested in removed thunk", function(assert) {
  ...
  var thunkTree = h(".page", [h(".section", [new Thunk()])]);
  var empty = h(".empty");
