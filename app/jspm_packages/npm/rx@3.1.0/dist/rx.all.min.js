...
(function(process) {
  (function(a) {
    ...
    function f(a, b) {
      if (Qa && b.stack && "object" == typeof a && null !== a && a.stack && -1 === a.stack.indexOf(Ua)) {
        for (var c = [],
            d = b; d; d = d.source)
    ...
    function l(a) {
      ...
      if (!Cb(a))
        return b;
      Bb.nonEnumArgs && a.length && Db(a) && (a = Fb.call(a));
      var c = Bb.enumPrototypes && "function" == typeof a,
          d = Bb.enumErrorProps && (a === vb || a instanceof Error);
      for (var e in a)
        c && "prototype" == e || d && ("message" == e || "name" == e) || b.push(e);
      if (Bb.nonEnumShadows && a !== wb) {
        var f = a.constructor,
            g = -1,
            h = hb;
        if (a === (f && f.prototype))
          var i = a === xb ? rb : a === vb ? mb : sb.call(a),
              j = Ab[i];
        for (; ++g < h; )
          e = gb[g], j && j[e] || !tb.call(a, e) || b.push(e);
      }
      return b;
    }
    function m(a, b, c) {
    ...
    function p(a, b, c, d) {
      ...
      var i = g == jb;
      if (!i) {
        if (g != pb || !Bb.nodeClass && (o(a) || o(b)))
          return !1;
        var j = !Bb.argsObject && Db(a) ? Object : a.constructor,
            k = !Bb.argsObject && Db(b) ? Object : b.constructor;
        if (!(j == k || tb.call(a, "constructor") && tb.call(b, "constructor") || Oa(j) && j instanceof j && Oa(k) && k instanceof k || !("constructor" in a && "constructor" in b)))
          return !1;
      }
      c || (c = []), d || (d = []);
      ...
      if (c.push(a), d.push(b), i) {
        ...
        n(b, function(b, e, f) {
          return tb.call(f, e) ? (m++, q = tb.call(a, e) && p(a[e], b, c, d)) : void 0;
        }), q && n(a, function(a, b, c) {
          return tb.call(c, b) ? q = --m > -1 : void 0;
        });
    ...
    function y(a) {
      return "number" == typeof a && Fa.isFinite(a);
    }
    function z(b) {
      var c,
          d = b[ab];
      if (!d && "string" == typeof b)
        return c = new u(b), c[ab]();
      if (!d && b.length !== a)
        return c = new w(b), c[ab]();
      if (!d)
    ...
    function B(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && y(b) ? (b = A(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > Mc ? Mc : b) : b;
    }
    function C(a, b) {
      this.observer = a, this.parent = b;
    }
    function D(a, b) {
      return Yb(a) || (a = bc), new Oc(b, a);
    }
    function E(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function H(a, b) {
      return new Sd(function(c) {
        var d = new Sb,
            e = new Tb;
        return e.setDisposable(d), d.setDisposable(a.subscribe(new $c(c, e, b))), e;
      }, a);
    }
    function I() {
      return !1;
    ...
    function P(a, b, c) {
      ...
      return a.map(function(b, c) {
        var e = d(b, c, a);
        return Na(e) && (e = Ec(e)), (db(e) || cb(e)) && (e = Nc(e)), e;
      }).concatAll();
    }
    function Q(a, b, c) {
      for (var d = 0,
    ...
    function W(a) {
      return a ? tc.isObservable(a) ? a : Na(a) ? tc.fromPromise(a) : _(a) || $(a) ? zd.call(this, a) : Oa(a) ? Z.call(this, a) : db(a) || cb(a) ? X.call(this, a) : Cb(a) ? Y.call(this, a) : a : a;
    }
    function X(a) {
      return tc.from(a).flatMap(W).toArray();
    }
    function Y(b) {
      function c(b, c) {
      ...
      for (var d = new b.constructor,
        ...
        var i = e[g],
            j = W.call(this, b[i]);
        j && tc.isObservable(j) ? c(j, i) : d[i] = b[i];
      }
      return tc.forkJoin.apply(tc, f).map(function() {
        return d;
      });
    }
    function Z(a) {
    ...
    function aa(a, b, c, d) {
      var e = new Wd;
      return d.push(ba(e, b, c)), a.apply(b, d), e.asObservable();
    }
    function ba(a, b, c) {
      return function() {
    ...
    function fa(a, b, c) {
      ...
      if ("[object NodeList]" === e || "[object HTMLCollection]" === e)
        for (var f = 0,
            g = a.length; g > f; f++)
          d.add(fa(a.item(f), b, c));
      else
        a && d.add(new ea(a, b, c));
      return d;
    }
    function ga(a, b) {
      return function() {
        var c = arguments[0];
        return Oa(b) && (c = d(b).apply(null, arguments), c === Pa) ? a.onError(c.e) : void a.onNext(c);
      };
    }
    function ha(a, b, c) {
      return new Sd(function(e) {
        function f(a, b) {
          if (k[b] = a, h[b] = !0, i || (i = h.every(Ia))) {
            if (g)
              return e.onError(g);
    ...
    function ia(a, b) {
      return a.groupJoin(this, b, Jc, function(a, b) {
        return b;
      });
    }
    function ja(a) {
      ...
      return new Sd(function(c) {
        var d = new Vd,
            e = new Lb,
            f = new Ub(e);
        return c.onNext(Ib(d, f)), e.add(b.subscribe(function(a) {
          d.onNext(a);
        }, function(a) {
          d.onError(a), c.onError(a);
        }, function() {
          d.onCompleted(), c.onCompleted();
        })), Na(a) && (a = Ec(a)), e.add(a.subscribe(function(a) {
          d.onCompleted(), d = new Vd, c.onNext(Ib(d, f));
        }, function(a) {
          d.onError(a), c.onError(a);
        }, function() {
          d.onCompleted(), c.onCompleted();
    ...
    function ka(a) {
      ...
      return new Sd(function(c) {
        function d() {
          ...
          Na(b) && (b = Ec(b));
          var i = new Sb;
          e.setDisposable(i), i.setDisposable(b.take(1).subscribe(Ha, function(a) {
            h.onError(a), c.onError(a);
          }, function() {
            h.onCompleted(), h = new Vd, c.onNext(Ib(h, g)), d();
          }));
        }
        var e = new Tb,
            f = new Lb(e),
            g = new Ub(f),
            h = new Vd;
        return c.onNext(Ib(h, g)), f.add(b.subscribe(function(a) {
          h.onNext(a);
        }, function(a) {
          h.onError(a), c.onError(a);
        }, function() {
 ...
 while (null !== g);
    ...
    function wa(a, b) {
      return new Sd(function(c) {
        ...
        return h.setDisposable(a.subscribe(function(a) {
          ...
          f = !0, h.dispose();
        })), new Lb(h, b.subscribe(d, function(a) {
          c.onError(a);
        }, d));
      }, a);
    }
    var xa,
        ...
        za = ya[typeof exports] && exports && !exports.nodeType && exports,
        Aa = ya[typeof self] && self.Object && self,
        Ba = ya[typeof window] && window && window.Object && window,
        Ca = ya[typeof module] && module && !module.nodeType && module,
        Da = Ca && Ca.exports === za && za,
        Ea = za && Ca && "object" == typeof global && global && global.Object && global,
        Fa = Fa = Ea || Ba !== (this && this.window) && Ba || Aa || this,
        Ga = {
          internals: {},
          config: {Promise: Fa.Promise},
          helpers: {}
        },
        Ha = Ga.helpers.noop = function() {},
        Ia = Ga.helpers.identity = function(a) {
          return a;
        },
        Ja = Ga.helpers.defaultNow = Date.now,
        Ka = Ga.helpers.defaultComparer = function(a, b) {
          return Eb(a, b);
        },
        La = Ga.helpers.defaultSubComparer = function(a, b) {
          return a > b ? 1 : b > a ? -1 : 0;
        },
        Ma = (Ga.helpers.defaultKeySerializer = function(a) {
          return a.toString();
        }, Ga.helpers.defaultError = function(a) {
          throw a;
        }),
        Na = Ga.helpers.isPromise = function(a) {
          return !!a && "function" != typeof a.subscribe && "function" == typeof a.then;
        },
        Oa = Ga.helpers.isFunction = function() {
          var a = function(a) {
            return "function" == typeof a || !1;
          };
          return a(/x/) && (a = function(a) {
            return "function" == typeof a && "[object Function]" == sb.call(a);
          }), a;
        }(),
        Pa = {e: {}};
    Ga.config.longStackSupport = !1;
    var Qa = !1,
        Ra = d(function() {
          throw new Error;
        })();
    ...
    var $a = Ga.helpers.notImplemented = function() {
      throw new Za;
    },
        _a = Ga.helpers.notSupported = function() {
          throw new Ya;
        },
        ab = "function" == typeof Symbol && Symbol.iterator || "_es6shim_iterator_";
    Fa.Set && "function" == typeof(new Fa.Set)["@@iterator"] && (ab = "@@iterator");
    var bb = Ga.doneEnumerator = {
      done: !0,
      value: a
    },
        cb = Ga.helpers.isIterable = function(b) {
          return b[ab] !== a;
        },
        db = Ga.helpers.isArrayLike = function(b) {
          return b && b.length !== a;
        };
    Ga.helpers.iterator = ab;
    var eb,
        fb = Ga.internals.bindCallback = function(a, b, c) {
        ...
        ub = sb.call(arguments) == ib,
        vb = Error.prototype,
        wb = Object.prototype,
        xb = String.prototype,
        yb = wb.propertyIsEnumerable;
    try {
      eb = !(sb.call(document) == pb && !({toString: 0} + ""));
    } catch (zb) {
      eb = !0;
    }
    var Ab = {};
    ...
    !function() {
      ...
      for (c in arguments)
        ;
      Bb.enumErrorProps = yb.call(vb, "message") || yb.call(vb, "name"), Bb.enumPrototypes = yb.call(a, "prototype"), Bb.nonEnumArgs = 0 != c, Bb.nonEnumShadows = !/valueOf/.test(b);
    }(1);
    var Cb = Ga.internals.isObject = function(a) {
      var b = typeof a;
      return a && ("function" == b || "object" == b) || !1;
    },
        Db = function(a) {
          return a && "object" == typeof a ? sb.call(a) == ib : !1;
        };
    ub || (Db = function(a) {
      return a && "object" == typeof a ? tb.call(a, "callee") : !1;
    });
    var Eb = Ga.internals.isEqual = function(a, b) {
      return p(a, b, [], []);
    },
        Fb = ({}.hasOwnProperty, Array.prototype.slice),
        Gb = Ga.internals.inherits = function(a, b) {
          function c() {
            this.constructor = a;
          }
          c.prototype = b.prototype, a.prototype = new c;
        },
        Hb = Ga.internals.addProperties = function(a) {
          for (var b = [],
              c = 1,
        ...
        Ib = Ga.internals.addRef = function(a, b) {
          return new Sd(function(c) {
    ...
    var Jb = Ga.internals.PriorityQueue = function(a) {
    ...
    var Lb = Ga.CompositeDisposable = function() {
      var a,
          b,
          c = [];
    ...
    var Nb = Ga.Disposable = function(a) {
      this.isDisposed = !1, this.action = a || Ha;
    };
    ...
    var Ob = Nb.create = function(a) {
      return new Nb(a);
        ...
        Pb = Nb.empty = {dispose: Ha},
        Qb = Nb.isDisposable = function(a) {
          return a && Oa(a.dispose);
        },
        Rb = Nb.checkDisposed = function(a) {
          if (a.isDisposed)
            throw new Wa;
        },
        Sb = Ga.SingleAssignmentDisposable = function() {
          this.isDisposed = !1, this.current = null;
        };
    Sb.prototype.getDisposable = function() {
      return this.current;
    }, Sb.prototype.setDisposable = function(a) {
      if (this.current)
    ...
    var Tb = Ga.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    ...
    var Ub = Ga.RefCountDisposable = function() {
      function a(a) {
    ...
    var Vb = Ga.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || La, this.disposable = new Sb;
    };
    ...
    var Wb = Ga.Scheduler = function() {
      ...
      }, a.now = Ja, a.normalize = function(a) {
        return 0 > a && (a = 0), a;
      }, a;
    }(),
        Xb = Wb.normalize,
    ...
    !function(a) {
      function b(a, b) {
        function c(b) {
          function d(a, b) {
            return g ? f.remove(i) : h = !0, e(b, c), Pb;
          }
          var g = !1,
              h = !1,
      ...
      function c(a, b, c) {
        function d(b, e) {
          function h(a, b) {
            return i ? g.remove(k) : j = !0, f(b, d), Pb;
          }
          var i = !1,
              j = !1,
              k = a[c](b, e, h);
      ...
      Wb.prototype.schedulePeriodic = function(a, b) {
        ...
        if ("undefined" == typeof Fa.setInterval)
          throw new Ya;
        b = Xb(b);
        var d = a,
            e = Fa.setInterval(function() {
              d = c(d);
            }, b);
        return Ob(function() {
          Fa.clearInterval(e);
    ...
    var Zb,
        $b,
        _b = Ga.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
        ...
        ac = Wb.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new Wb(Ja, a, _a, _a);
        }(),
        bc = Wb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.shift();
          ...
          function b(b, f) {
            var g = new Vb(this, b, f, this.now());
            if (c)
              c.push(g);
            else {
              c = [g];
        ...
        cc = function() {
          var a,
              b = Ha;
          if (Fa.setTimeout)
            a = Fa.setTimeout, b = Fa.clearTimeout;
          else {
            if (!Fa.WScript)
              throw new Ya;
            a = function(a, b) {
              Fa.WScript.Sleep(b), a();
            };
          }
          return {
            setTimeout: a,
    ...
    !function() {
      ...
      function b() {
        if (!Fa.postMessage || Fa.importScripts)
          return !1;
        var a = !1,
            b = Fa.onmessage;
        return Fa.onmessage = function() {
          a = !0;
        }, Fa.postMessage("", "*"), Fa.onmessage = b, a;
      }
      function c(b) {
      ...
      var i = RegExp("^" + String(sb).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
          j = "function" == typeof(j = Ea && Da && Ea.setImmediate) && !i.test(j) && j;
      if (Oa(j))
        Zb = function(b) {
          var c = f++;
        ...
        Fa.addEventListener ? Fa.addEventListener("message", c, !1) : Fa.attachEvent ? Fa.attachEvent("onmessage", c) : Fa.onmessage = c, Zb = function(a) {
          var b = f++;
          return g[b] = a, Fa.postMessage(k + currentId, "*"), b;
        };
      } else if (Fa.MessageChannel) {
        var l = new Fa.MessageChannel;
        ...
        Zb = "document" in Fa && "onreadystatechange" in Fa.document.createElement("script") ? function(b) {
          var c = Fa.document.createElement("script"),
              d = f++;
          return g[d] = b, c.onreadystatechange = function() {
            a(d), c.onreadystatechange = null, c.parentNode.removeChild(c), c = null;
          }, Fa.document.documentElement.appendChild(c), d;
        } : function(b) {
          var c = f++;
          return g[c] = b, dc(function() {
            a(c);
          }, 0), c;
        };
    }();
    var fc = Wb.timeout = Wb["default"] = function() {
      function a(a, b) {
        var c = this,
            d = new Sb,
            e = Zb(function() {
      ...
      return new Wb(Ja, a, b, c);
        ...
        gc = function(a) {
          ...
          return Gb(e, a), e.prototype._clone = function(a) {
        ...
        hc = Ga.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return Yb(a) || (a = ac), new Sd(function(c) {
        ...
        ic = hc.createOnNext = function() {
          ...
          return function(d) {
            return new hc("N", d, null, a, b, c);
          };
        }(),
        jc = hc.createOnError = function() {
          function a(a, b) {
          ...
          return function(d) {
            return new hc("E", null, d, a, b, c);
          };
        }(),
        kc = hc.createOnCompleted = function() {
          function a(a, b, c) {
            return c();
          }
          function b(a) {
          ...
          return function() {
            return new hc("C", null, null, a, b, c);
          };
        }(),
        lc = Ga.Observer = function() {};
    ...
    var mc = lc.create = function(a, b, c) {
      return a || (a = Ha), b || (b = Ma), c || (c = Ha), new pc(a, b, c);
    };
    lc.fromNotifier = function(a, b) {
      var c = fb(a, b, 1);
      return new pc(function(a) {
        return c(ic(a));
      }, function(a) {
        return c(jc(a));
      }, function() {
    ...
    var nc,
        oc = Ga.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1;
          }
          return Gb(b, a), b.prototype.next = $a, b.prototype.error = $a, b.prototype.completed = $a, b.prototype.onNext = function(a) {
        ...
        pc = Ga.AnonymousObserver = function(a) {
          function b(b, c, d) {
            a.call(this), this._onNext = b, this._onError = c, this._onCompleted = d;
          }
          return Gb(b, a), b.prototype.next = function(a) {
            this._onNext(a);
        ...
        rc = Ga.internals.ScheduledObserver = function(a) {
          function b(b, c) {
          ...
          return Gb(b, a), b.prototype.next = function(a) {
            ...
            !this.hasFaulted && this.queue.length > 0 && (a = !this.isAcquired, this.isAcquired = !0), a && this.disposable.setDisposable(this.scheduler.scheduleRecursiveWithState(this, function(a, b) {
              ...
              c = a.queue.shift();
              var f = d(c)();
              return f === Pa ? (a.queue = [], a.hasFaulted = !0, e(f.e)) : void b(a);
            }));
          }, b.prototype.dispose = function() {
        ...
        sc = function(a) {
          ...
          return Gb(b, a), b.prototype.next = function(b) {
        ...
        tc = Ga.Observable = function() {
          ...
          function b(b) {
            if (Ga.config.longStackSupport && Qa) {
              var c = d(e)(new Error).e;
              this.stack = c.stack.substring(c.stack.indexOf("\n") + 1), this._subscribe = a(this, b);
            } else
              this._subscribe = b;
          }
          return nc = b.prototype, b.isObservable = function(a) {
            return a && Oa(a.subscribe);
          }, nc.subscribe = nc.forEach = function(a, b, c) {
        ...
        uc = Ga.ObservableBase = function(a) {
          function b(a) {
            return a && Oa(a.dispose) ? a : Oa(a) ? Ob(a) : Pb;
          }
          function c(a, c) {
            var f = c[0],
                g = c[1],
                h = d(g.subscribeCore).call(g, f);
            return h !== Pa || f.fail(Pa.e) ? void f.setDisposable(b(h)) : e(Pa.e);
          }
          function f(a) {
            var b = new Td(a),
                d = [b, this];
            return bc.scheduleRequired() ? bc.scheduleWithState(d, c) : c(null, d), b;
          }
          function g() {
            a.call(this, f);
          }
          return Gb(g, a), g.prototype.subscribeCore = $a, g;
        }(tc),
        vc = function(a) {
          function b(b, c, d, e) {
            this.resultSelector = Ga.helpers.isFunction(d) ? d : null, this.selector = Ga.internals.bindCallback(Ga.helpers.isFunction(c) ? c : function() {
              return c;
          ...
          return Gb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              ...
              Ga.helpers.isPromise(c) && (c = Ga.Observable.fromPromise(c)), (Ga.helpers.isArrayLike(c) || Ga.helpers.isIterable(c)) && (c = Ga.Observable.from(c)), this.o.onNext(this._wrapResult(c, a, b));
            }
        ...
        wc = Ga.internals.Enumerable = function() {},
        xc = function(a) {
          function b(b) {
          ...
          return Gb(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                e = new Tb,
                f = ac.scheduleRecursiveWithState(this.sources[ab](), function(f, g) {
                  if (!b) {
    ...
    var yc = function(a) {
      ...
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[ab](),
            e = new Tb,
            f = ac.scheduleRecursiveWithState(null, function(f, g) {
              if (!b) {
    ...
    wc.prototype.catchError = function() {
      ...
      return new Sd(function(c) {
        var e,
            ...
            k = b[ab](),
            l = new Tb,
            m = ac.scheduleRecursive(function(a) {
              if (!e) {
                ...
                var j = new Sb,
                    m = new Sb;
                l.setDisposable(new Lb(m, j)), j.setDisposable(i.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
        ...
        return new Lb(j, l, m, Ob(function() {
          e = !0;
        }));
      });
    };
    var zc = function(a) {
      ...
      return Gb(b, a), b.prototype[ab] = function() {
        return new c(this);
      }, c.prototype.next = function() {
        return 0 === this.l ? bb : (this.l > 0 && this.l--, {
          done: !1,
          value: this.v
        });
      }, b;
    }(wc),
        Ac = wc.repeat = function(a, b) {
          return new zc(a, b);
        },
        Bc = function(a) {
          function b(a, b, c) {
            this.s = a, this.fn = b ? fb(b, c, 3) : null;
          }
          function c(a) {
    ...
    var Dc = function(a) {
      ...
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Ec = tc.fromPromise = function(a) {
          return new Dc(a);
        };
    nc.toPromise = function(a) {
      if (a || (a = Ga.config.Promise), !a)
        throw new Ya("Promise type not provided nor in Rx.config.Promise");
      var b = this;
    ...
    nc.toArray = function() {
      return new Fc(this);
    }, tc.create = function(a, b) {
      return new Sd(a, b);
    };
    var Gc = tc.defer = function(a) {
      return new Sd(function(b) {
        var c;
        try {
          c = a();
        } catch (d) {
          return Zc(d).subscribe(b);
        }
        return Na(c) && (c = Ec(c)), c.subscribe(b);
      });
    },
        Hc = function(a) {
          function b(b) {
        ...
        Ic = new Hc(ac),
        Jc = tc.empty = function(a) {
          return Yb(a) || (a = ac), a === ac ? Ic : new Hc(a);
        },
        Kc = function(a) {
          function b(b, c, d) {
        ...
        Lc = function() {
          ...
          return a.prototype.run = function() {
            function a(a, b) {
              ...
              var h = g.value;
              return Oa(f) && (h = d(f)(h, a), h === Pa) ? e.onError(h.e) : (e.onNext(h), void b(a + 1));
            }
    ...
    var Nc = tc.from = function(a, b, c, d) {
      if (null == a)
    ...
    var Pc = tc.fromArray = function(a, b) {
      return Yb(b) || (b = bc), new Oc(a, b);
    };
    tc.generate = function(a, b, c, d, e) {
      return Yb(e) || (e = bc), new Sd(function(f) {
        var g = !0;
    ...
    var Xc = function(a) {
      ...
      function d(a, b) {
        var c = b[0],
            d = b[1];
        return d.onNext(c), d.onCompleted(), Pb;
      }
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return this.scheduler === ac ? d(null, a) : this.scheduler.scheduleWithState(a, d);
      }, b;
    }(uc),
        Yc = (tc["return"] = tc.just = function(a, b) {
          return Yb(b) || (b = ac), new Xc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        Zc = tc["throw"] = function(a, b) {
          return Yb(b) || (b = ac), new Yc(a, b);
        };
    tc.using = function(a, b) {
      return new Sd(function(c) {
        var e = Pb,
            f = d(a)();
        if (f === Pa)
          return new Lb(Zc(f.e).subscribe(c), e);
        f && (e = f);
        var g = d(b)(f);
        return g === Pa ? new Lb(Zc(g.e).subscribe(c), e) : new Lb(g.subscribe(c), e);
      });
    }, nc.amb = function(a) {
      var b = this;
      return new Sd(function(c) {
        ...
        return i.setDisposable(b.subscribe(k)), j.setDisposable(a.subscribe(l)), new Lb(i, j);
      });
    }, tc.amb = function() {
      var a,
          b = Sc();
    ...
    nc["catch"] = function(a) {
      return Oa(a) ? H(this, a) : _c([this, a]);
    };
    var _c = tc["catch"] = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
    ...
    nc.combineLatest = function() {
      for (var a = arguments.length,
          ...
          c = 0; a > c; c++)
        b[c] = arguments[c];
      return Array.isArray(b[0]) ? b[0].unshift(this) : b.unshift(this), ad.apply(this, b);
    };
    var ad = tc.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = Oa(b[a - 1]) ? b.pop() : J;
      return Array.isArray(b[0]) && (b = b[0]), new Sd(function(a) {
        function c(b) {
          if (g[b] = !0, h || (h = g.every(Ia))) {
            try {
            ...
            i.filter(function(a, c) {
              return c !== b;
            }).every(Ia) && a.onCompleted();
        }
        function e(b) {
          i[b] = !0, i.every(Ia) && a.onCompleted();
        }
        for (var f = b.length,
            g = q(f, I),
            h = !1,
          ...
          !function(d) {
            var f = b[d],
                g = new Sb;
            Na(f) && (f = Ec(f)), g.setDisposable(f.subscribe(function(a) {
              j[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    nc.concat = function() {
      for (var a = [],
        ...
        a.push(arguments[b]);
      return a.unshift(this), cd.apply(null, a);
    };
    var bd = function(a) {
      function b(b) {
        this.sources = b, a.call(this);
      ...
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = ac.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
                  return e.onCompleted();
                var h = c[f];
        ...
        return new Lb(b, f, Ob(function() {
          a = !0;
        }));
      }, b;
    }(uc),
        cd = tc.concat = function() {
          var a;
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
    ...
    var dd = function(a) {
      ...
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new Lb;
        return b.add(this.source.subscribe(new ed(a, this.maxConcurrent, b))), b;
      }, b;
    }(uc),
        ed = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new Sb;
            this.g.add(c), Na(a) && (a = Ec(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    nc.merge = function(a) {
      return "number" != typeof a ? fd(this, a) : new dd(this, a);
    };
    var fd = tc.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
      ...
      return Array.isArray(c[0]) && (c = c[0]), D(a, c).mergeAll();
        ...
        gd = function(a) {
          ...
          return Gb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              var b = new Sb;
              this.g.add(b), Na(a) && (a = Ec(a)), b.setDisposable(a.subscribe(new d(this, b)));
            }
          }, c.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, c.prototype.onCompleted = function() {
    ...
    var hd = Ga.CompositeError = function(a) {
    ...
    hd.prototype = Error.prototype, tc.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new Sd(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : 1 === g.length ? a.onError(g[0]) : a.onError(new hd(g));
        }
        var c = new Lb,
            e = new Sb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new Sb;
          c.add(e), Na(d) && (d = Ec(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    var id = tc.onErrorResumeNext = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
      ...
      return new Sd(function(b) {
        var c = 0,
            d = new Tb,
            e = ac.scheduleRecursive(function(e) {
              var f,
                  g;
              c < a.length ? (f = a[c++], Na(f) && (f = Ec(f)), g = new Sb, d.setDisposable(g), g.setDisposable(f.subscribe(b.onNext.bind(b), e, e))) : b.onCompleted();
            });
        return new Lb(d, e);
      });
    };
    ...
    var jd = function(a) {
      ...
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new Sb,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), Na(a) && (a = Ec(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    var kd = function(a) {
      function b(b, c) {
        this.source = b, this.other = Na(c) ? Ec(c) : c, a.call(this);
      }
      function c(a) {
        this.o = a, this.isStopped = !1;
      }
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        return new Lb(this.source.subscribe(a), this.other.subscribe(new c(a)));
      }, c.prototype.onNext = function(a) {
    ...
    nc.takeUntil = function(a) {
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Sd(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new Sb;
            Na(d) && (d = Ec(d)), e.setDisposable(d.subscribe(function(a) {
              i[c] = a, g[c] = !0, h = g.every(Ia);
            }, function(b) {
              a.onError(b);
            }, Ha)), j[c] = e;
          }(k);
        ...
        return l.setDisposable(f.subscribe(function(b) {
          ...
          if (h) {
            ...
            return f === Pa ? a.onError(f.e) : void a.onNext(f);
          }
        }, function(b) {
          a.onError(b);
        }, function() {
      ...
      for (var a = arguments.length,
          ...
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var e = Oa(b[a - 1]) ? b.pop() : J;
      Array.isArray(b[0]) && (b = b[0]);
      var f = this;
      return b.unshift(f), new Sd(function(a) {
        for (var c = b.length,
            g = q(c, K),
            h = q(c, I),
            i = new Array(c),
          ...
          !function(c) {
            var j = b[c],
                k = new Sb;
            Na(j) && (j = Ec(j)), k.setDisposable(j.subscribe(function(b) {
              ...
              h[c] = !0, h.every(Ia) && a.onCompleted();
            })), i[c] = k;
          }(j);
        return new Lb(i);
      }, f);
      ...
      return b.unshift(f), new Sd(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var j = b[c],
                k = new Sb;
            (db(j) || cb(j)) && (j = Nc(j)), k.setDisposable(j.subscribe(function(b) {
              if (g[c].push(b), g.every(function(a) {
                return a.length > 0;
              })) {
                var i = g.map(function(a) {
    ...
    var ld = function(a) {
      ...
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new md(a, this.keyFn, this.comparer));
      }, b;
    }(uc),
        md = function(a) {
          function b(b, c, d) {
          ...
          return Gb(b, a), b.prototype.next = function(a) {
            var b,
                c = a;
            return Oa(this.keyFn) && (c = d(this.keyFn)(a), c === Pa) ? this.o.onError(c.e) : this.hasCurrentKey && (b = d(this.comparer)(this.currentKey, c), b === Pa) ? this.o.onError(b.e) : void(this.hasCurrentKey && b || (this.hasCurrentKey = !0, this.currentKey = c, this.o.onNext(a)));
          }, b.prototype.error = function(a) {
            this.o.onError(a);
          }, b.prototype.completed = function() {
            this.o.onCompleted();
    ...
    var nd = function(a) {
      ...
      function c(a, b) {
        this.o = a, this.t = !b._oN || Oa(b._oN) ? mc(b._oN || Ha, b._oE || Ha, b._oC || Ha) : b._oN, this.isStopped = !1;
      }
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          ...
          b === Pa && this.o.onError(b.e), this.o.onNext(a);
        }
      }, c.prototype.onError = function(a) {
        if (!this.isStopped) {
          this.isStopped = !0;
    ...
    nc["do"] = nc.tap = nc.doAction = function(a, b, c) {
      ...
      return this.tap(Ha, "undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, nc.doOnCompleted = nc.tapOnCompleted = function(a, b) {
      return this.tap(Ha, null, "undefined" != typeof b ? function() {
        a.call(b);
      } : a);
    }, nc["finally"] = function(a) {
      var b = this;
      return new Sd(function(c) {
        var f = d(b.subscribe).call(b, c);
        return f === Pa ? (a(), e(f.e)) : Ob(function() {
    ...
    var od = function(a) {
      ...
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new c(a));
      }, c.prototype.onNext = Ha, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
        this.isStopped || (this.isStopped = !0, this.o.onCompleted());
      }, c.prototype.dispose = function() {
    ...
    nc.ignoreElements = function() {
      ...
      return new Sd(function(b) {
        return a.subscribe(function(a) {
          ...
          b.onNext(jc(a)), b.onCompleted();
        }, function() {
          b.onNext(kc()), b.onCompleted();
        });
      }, a);
    }, nc.repeat = function(a) {
      return Ac(this, a).concat();
    }, nc.retry = function(a) {
      return Ac(this, a).catchError();
    }, nc.retryWhen = function(a) {
      return Ac(this).catchErrorWhen(a);
    };
    var pd = function(a) {
      function b(b, c, d, e) {
    ...
    O.prototype = {
      onNext: function(a) {
        return this.isStopped ? void 0 : (!this.hasValue && (this.hasValue = !0), this.hasAccumulation ? this.accumulation = d(this.accumulator)(this.accumulation, a) : (this.accumulation = this.hasSeed ? d(this.accumulator)(this.seed, a) : a, this.hasAccumulation = !0), this.accumulation === Pa ? this.o.onError(this.accumulation.e) : void this.o.onNext(this.accumulation));
      },
      onError: function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      },
      ...
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new pd(this, c, b, a);
      ...
      var a,
          b = 0;
      arguments.length && Yb(arguments[0]) ? (a = arguments[0], b = 1) : a = ac;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return Cc([Pc(c, a), this]).concat();
      ...
      return Oa(a) && Oa(b) ? this.concatMap(function(c, d) {
        var e = a(c, d);
        return Na(e) && (e = Ec(e)), (db(e) || cb(e)) && (e = Nc(e)), e.map(function(a, e) {
          return b(c, a, d, e);
        });
      }) : Oa(a) ? P(this, a, c) : P(this, function() {
        return a;
      });
      ...
      return new Sd(function(a) {
        ...
        return e.subscribe(function(c) {
          ...
          Na(c) && (c = Ec(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          Na(b) && (b = Ec(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    }, nc.defaultIfEmpty = function(b) {
      var c = this;
      return b === a && (b = null), new Sd(function(a) {
        var d = !1;
      ...
      var b = -1 === Q(this.set, a, this.comparer);
      return b && this.set.push(a), b;
    }, nc.distinct = function(a, b) {
      var c = this;
      return b || (b = Ka), new Sd(function(d) {
        var e = new R(b);
        return c.subscribe(function(b) {
          var c = b;
          if (a)
    ...
    }, nc.groupBy = function(a, b) {
      return this.groupByUntil(a, b, Sc);
    }, nc.groupByUntil = function(b, c, e) {
      var f = this;
      return new Sd(function(g) {
        var h = new Pd,
            i = new Lb,
            j = new Ub(i),
            k = function(a) {
        ...
        return i.add(f.subscribe(function(f) {
          ...
          var m = !1,
              n = h.get(l);
          if (n === a && (n = new Vd, h.set(l, n), m = !0), m) {
            var o = new Ud(l, n, j),
                p = new Ud(l, n),
                q = d(e)(p);
            if (q === Pa)
            ...
            g.onNext(o);
            var r = new Sb;
            i.add(r), r.setDisposable(q.take(1).subscribe(Ha, function(a) {
          ...
          var s = f;
          return Oa(c) && (s = d(c)(f), s === Pa) ? (h.forEach(k(s.e)), g.onError(s.e)) : void n.onNext(s);
        }, function(a) {
          h.forEach(k(a)), g.onError(a);
        }, function() {
    ...
    var qd = function(a) {
      function b(b, c, d) {
        this.source = b, this.selector = fb(c, d, 3), a.call(this);
      }
      function c(a, b) {
        return function(c, d, e) {
      ...
      return Gb(b, a), b.prototype.internalMap = function(a, d) {
        ...
        if (!this.isStopped) {
          ...
          return b === Pa ? this.o.onError(b.e) : void this.o.onNext(b);
        }
    ...
    nc.map = nc.select = function(a, b) {
      ...
      for (var c = 0; a > c; c++)
        b[c] = arguments[c];
      return this.map(S(b, a));
    }, nc.flatMap = nc.selectMany = function(a, b, c) {
      return new vc(this, a, b, c).mergeAll();
    }, nc.flatMapObserver = nc.selectManyObserver = function(a, b, c, d) {
      var e = this;
      return new Sd(function(f) {
        var g = 0;
        return e.subscribe(function(b) {
          ...
          Na(c) && (c = Ec(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          Na(a) && (a = Ec(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    }, Ga.Observable.prototype.flatMapLatest = function(a, b, c) {
      return new vc(this, a, b, c).switchLatest();
    };
    var rd = function(a) {
      function b(b, c) {
    ...
    var sd = function(a) {
      function b(b, c, d) {
        this.source = b, this.predicate = fb(c, d, 3), a.call(this);
      }
      function c(a, b) {
        return function(c, d, e) {
      ...
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          ...
          return b === Pa ? this.o.onError(b.e) : void(b && this.o.onNext(a));
        }
      }, e.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, e.prototype.onCompleted = function() {
    ...
    nc.filter = nc.where = function(a, b) {
      return this instanceof sd ? this.internalFilter(a, b) : new sd(this, a, b);
    };
    var td = function(a) {
      function b(b, c, d, e) {
      ...
      return Gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        this.isStopped || (!this.hasValue && (this.hasValue = !0), this.hasAccumulation ? this.result = d(this.acc)(this.result, a) : (this.result = this.hasSeed ? d(this.acc)(this.seed, a) : a, this.hasAccumulation = !0), this.result === Pa && this.o.onError(this.result.e));
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
        this.isStopped || (this.isStopped = !0, this.hasValue && this.o.onNext(this.result), !this.hasValue && this.hasSeed && this.o.onNext(this.seed), !this.hasValue && !this.hasSeed && this.o.onError(new Va), this.o.onCompleted());
      }, c.prototype.dispose = function() {
        this.isStopped = !0;
      }, c.prototype.fail = function(a) {
        return this.isStopped ? !1 : (this.isStopped = !0, this.o.onError(a), !0);
    ...
    var ud = function(a) {
      ...
      return Gb(b, a), b.prototype.next = function(a) {
        ...
        return b === Pa ? this._o.onError(b.e) : void(Boolean(b) && (this._o.onNext(!0), this._o.onCompleted()));
      }, b.prototype.error = function(a) {
        this._o.onError(a);
      }, b.prototype.completed = function() {
    ...
    nc.some = function(a, b) {
      var c = this,
          d = fb(a, b, 3);
      return new Sd(function(a) {
        return c.subscribe(new ud(a, d, c));
      });
    };
    var vd = function(a) {
      function b(b) {
      ...
      return Gb(b, a), b.prototype.next = function() {
        this._o.onNext(!1), this._o.onCompleted();
      }, b.prototype.error = function(a) {
        this._o.onError(a);
      }, b.prototype.completed = function() {
    ...
    var wd = function(a) {
      ...
      return Gb(b, a), b.prototype.next = function(a) {
        var b = d(this._fn)(a, this._i++, this._s);
        return b === Pa ? this._o.onError(b.e) : void(Boolean(b) || (this._o.onNext(!1), this._o.onCompleted()));
      }, b.prototype.error = function(a) {
        this._o.onError(a);
      }, b.prototype.completed = function() {
        this._o.onNext(!0), this._o.onCompleted();
    ...
    nc.every = function(a, b) {
      var c = this,
          d = fb(a, b, 3);
      return new Sd(function(a) {
        return c.subscribe(new wd(a, d, c));
      }, this);
      ...
      return a && Oa(a) ? this.map(a, b).sum() : this.reduce(function(a, b) {
        return a + b;
      }, 0);
    }, nc.minBy = function(a, b) {
      return b || (b = La), T(this, a, function(a, c) {
        return -1 * b(a, c);
      });
    }, nc.min = function(a) {
      return this.minBy(Ia, a).map(function(a) {
        return U(a);
      });
    }, nc.maxBy = function(a, b) {
      return b || (b = La), T(this, a, b);
    }, nc.max = function(a) {
      return this.maxBy(Ia, a).map(function(a) {
        return U(a);
      });
    };
    var xd = function(a) {
      ...
      return Gb(b, a), b.prototype.next = function(a) {
        ...
        return 0 === this._c ? this._o.onError(new Va) : (this._o.onNext(this._t / this._c), void this._o.onCompleted());
      }, b;
    }(oc);
    nc.average = function(a, b) {
      var c,
          d = this;
      return Oa(a) && (c = fb(a, b, 3)), new Sd(function(a) {
        return d.subscribe(new xd(a, c, d));
      }, d);
      ...
      return new Sd(function(e) {
        ...
        return d.subscribe(function(a) {
          ...
          c === a ? e.onError(new Xa) : (e.onNext(c), e.onCompleted());
        });
      }, d);
    ...
    var yd = function(b) {
      ...
      return Gb(c, b), c.prototype.next = function(a) {
        ...
        this._obj.defaultValue === a ? this._o.onError(new Va) : (this._o.onNext(this._obj.defaultValue), this._o.onCompleted());
      }, c;
    }(oc);
    nc.first = function() {
      var a = {},
      ...
      if (a = "object" == typeof arguments[0] ? arguments[0] : {
        ...
        var c = a.predicate;
        a.predicate = fb(c, a.thisArg, 3);
      }
      return new Sd(function(c) {
        return b.subscribe(new yd(c, a, b));
      }, b);
    }, nc.last = function() {
      var b = {},
          c = this;
      ...
      return new Sd(function(e) {
        ...
        return c.subscribe(function(a) {
          ...
          g ? (e.onNext(f), e.onCompleted()) : b.defaultValue === a ? e.onError(new Va) : (e.onNext(b.defaultValue), e.onCompleted());
        });
      }, c);
      ...
      function b() {
        return tc.spawn.call(this, a.apply(this, arguments));
      }
      return b.__generatorFunction__ = a, b;
    };
    var zd = tc.spawn = function() {
      ...
      return new Sd(function(e) {
        function f(b) {
          ...
          return c === Pa ? e.onError(c.e) : void h(c);
        }
        function g(b) {
          var c = d(a.next).call(a, b);
          return c === Pa ? e.onError(c.e) : void h(c);
        ...
        function h(a) {
          ...
          var c = W.call(b, a.value);
          tc.isObservable(c) ? i.add(c.subscribe(f, g)) : g(new TypeError("type not supported"));
        }
        var i = new Lb;
        return Oa(a) && (a = a.apply(b, c)), a && Oa(a.next) ? (f(), i) : (e.onNext(a), e.onCompleted());
      });
    };
    tc.start = function(a, b, c) {
      return Ad(a, b, c)();
    };
    var Ad = tc.toAsync = function(a, b, c) {
      return Yb(c) || (c = fc), function() {
        var d = arguments,
            e = new Wd;
    ...
    }, Ga.config.useNativeEvents = !1, tc.fromEvent = function(a, b, c) {
      return a.addListener ? Bd(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : Ga.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new Sd(function(d) {
        return fa(a, b, ga(d, c));
    ...
    var Bd = tc.fromEventPattern = function(a, b, c, e) {
      return Yb(e) || (e = ac), new Sd(function(e) {
        function f() {
          var a = arguments[0];
          return Oa(c) && (a = d(c).apply(null, arguments), a === Pa) ? e.onError(a.e) : void e.onNext(a);
        }
        var g = a(f);
        return Ob(function() {
          Oa(b) && b(f, g);
    ...
    var Cd = function(a) {
      ...
      function c(c, d) {
        this.source = c, this.controller = new Vd, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, a.call(this, b, c);
      }
      return Gb(c, a), c.prototype.pause = function() {
    ...
    var Dd = function(b) {
      function c(b) {
        ...
        var d,
            e = [],
            f = ha(this.source, this.pauser.startWith(!1).distinctUntilChanged(), function(a, b) {
              return {
                data: a,
                shouldFire: b
              };
      ...
      function d(a, d) {
        this.source = a, this.controller = new Vd, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, b.call(this, c, a);
      }
      return Gb(d, b), d.prototype.pause = function() {
        this.controller.onNext(!1);
    ...
    var Ed = function(a) {
      ...
      function c(c, d, e) {
        a.call(this, b, c), this.subject = new Fd(d, e), this.source = c.multicast(this.subject).refCount();
      }
      return Gb(c, a), c.prototype.request = function(a) {
        ...
        Fd = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new Vd, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = null, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || bc;
          }
          return Gb(c, a), Hb(c.prototype, lc, {
            onCompleted: function() {
              this.hasCompleted = !0, this.enableQueue && 0 !== this.queue.length ? this.queue.push(hc.createOnCompleted()) : (this.subject.onCompleted(), this.disposeCurrentRequest());
            },
            onError: function(a) {
              this.hasFailed = !0, this.error = a, this.enableQueue && 0 !== this.queue.length ? this.queue.push(hc.createOnError(a)) : (this.subject.onError(a), this.disposeCurrentRequest());
            },
            onNext: function(a) {
              this.requestedCount <= 0 ? this.enableQueue && this.queue.push(hc.createOnNext(a)) : (0 === this.requestedCount-- && this.disposeCurrentRequest(), this.subject.onNext(a));
            },
            ...
            request: function(a) {
              ...
              return this.requestedDisposable = this.scheduler.scheduleWithState(a, function(a, c) {
                ...
                return !e && d > 0 ? (b.requestedCount = d, Ob(function() {
                  b.requestedCount = 0;
                })) : void 0;
    ...
    nc.controlled = function(a, b) {
      return a && Yb(a) && (b = a, a = !0), null == a && (a = !0), new Ed(this, a, b);
    };
    var Gd = function(a) {
      function b(a) {
        this.subscription = this.source.subscribe(new d(a, this, this.subscription));
        var b = this;
        return fc.schedule(function() {
          b.source.request(1);
        }), this.subscription;
      }
      function c(c) {
    ...
    Ed.prototype.windowed = function(a) {
      ...
      var c = this;
      return "function" == typeof a ? new Sd(function(d) {
        var e = c.multicast(a());
        return new Lb(b(e).subscribe(d), e.connect());
      }, c) : new Ld(c, a);
    }, nc.publish = function(a) {
      return a && Oa(a) ? this.multicast(function() {
        return new Vd;
    ...
    var Jd = Ga.BehaviorSubject = function(a) {
      function c(a) {
      ...
      return Gb(d, a), Hb(d.prototype, lc, {
        getValue: function() {
        ...
        Kd = Ga.ReplaySubject = function(a) {
          function c(a, b) {
            return Ob(function() {
          ...
          function e(b, c, e) {
            this.bufferSize = null == b ? f : b, this.windowSize = null == c ? f : c, this.scheduler = e || bc, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this, d);
          }
          var f = Math.pow(2, 53) - 1;
          return Gb(e, a), Hb(e.prototype, lc.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
        ...
        Ld = Ga.ConnectableObservable = function(a) {
          function b(b, c) {
            var d,
                e = !1,
                f = b.asObservable();
          ...
          return Gb(b, a), b.prototype.refCount = function() {
            var a,
                b = 0,
                c = this;
            return new Sd(function(d) {
    ...
    nc.singleInstance = function() {
      ...
      return new Sd(function(g) {
        ...
        return h.add(f.subscribe(function(a) {
          ...
          m.set(c, a), h.add(f);
          var j = d(b)(a);
          return j === Pa ? g.onError(j.e) : (f.setDisposable(j.take(1).subscribe(Ha, o, function() {
            m["delete"](c) && 0 === m.size && i && g.onCompleted(), h.remove(f);
          })), void n.forEach(function(b) {
            var c = d(e)(a, b);
            return c === Pa ? g.onError(c.e) : void g.onNext(c);
          }));
        }, o, function() {
          ...
          n.set(b, a), h.add(f);
          var i = d(c)(a);
          return i === Pa ? g.onError(i.e) : (f.setDisposable(i.take(1).subscribe(Ha, o, function() {
      ...
      return new Sd(function(g) {
        ...
        return i.add(f.subscribe(function(a) {
          ...
          i.add(o);
          var p = d(b)(a);
          return p === Pa ? (k.forEach(h(p.e)), g.onError(p.e)) : void o.setDisposable(p.take(1).subscribe(Ha, function(a) {
          ...
          i.add(e);
          var f = d(c)(a);
          return f === Pa ? (k.forEach(h(f.e)), g.onError(f.e)) : (e.setDisposable(f.take(1).subscribe(Ha, function(a) {
            k.forEach(h(a)), g.onError(a);
          }, function() {
    ...
    nc.letBind = nc.let = function(a) {
      return a(this);
    }, tc["if"] = function(a, b, c) {
      return Gc(function() {
        return c || (c = Jc()), Na(b) && (b = Ec(b)), Na(c) && (c = Ec(c)), "function" == typeof c.now && (c = Jc(c)), a() ? b : c;
      });
    }, tc["for"] = tc.forIn = function(a, b, c) {
      return Cc(a, b, c).concat();
    };
    var Nd = tc["while"] = tc.whileDo = function(a, b) {
      return Na(b) && (b = Ec(b)), la(a, b).concat();
    };
    nc.doWhile = function(a) {
      return cd([this, Nd(a, this)]);
    }, tc["case"] = function(a, b, c) {
      return Gc(function() {
        Na(c) && (c = Ec(c)), c || (c = Jc()), Yb(c) && (c = Jc(c));
        var d = b[a()];
        return Na(d) && (d = Ec(d)), d || c;
      });
      ...
      return new Sd(function(b) {
        ...
        for (var d = new Lb,
          ...
          !function(i) {
            var j = a[i];
            Na(j) && (j = Ec(j)), d.add(j.subscribe(function(a) {
              e || (f[i] = !0, h[i] = a);
            }, function(a) {
      ...
      return new Sd(function(d) {
        var e,
            ...
            k = new Sb,
            l = new Sb;
        return Na(a) && (a = Ec(a)), k.setDisposable(c.subscribe(function(a) {
          i = !0, e = a;
        }, function(a) {
    ...
    }, nc.manySelect = nc.extend = function(a, b) {
      Yb(b) || (b = ac);
      var c = this;
      return Gc(function() {
        var d;
    ...
    var Od = function(a) {
      function b(a) {
        var b = this,
            c = new Lb;
        return c.add(bc.schedule(function() {
          a.onNext(b.head), c.add(b.tail.mergeAll().subscribe(a));
        })), c;
      }
      function c(c) {
        a.call(this, b), this.head = c, this.tail = new Wd;
      }
      return Gb(c, a), Hb(c.prototype, lc, {
        onCompleted: function() {
    ...
    var Qd = function(a) {
      ...
      }, c.error = Ha, c.completed = Ha, c.addActivePlan = function(a) {
    ...
    var Rd = tc.interval = function(a, b) {
      return ta(a, a, Yb(b) ? b : fc);
    };
    tc.timer = function(b, c, d) {
      var e;
      return Yb(d) || (d = fc), null != c && "number" == typeof c ? e = c : Yb(c) && (d = c), b instanceof Date && e === a ? qa(b.getTime(), d) : b instanceof Date && e !== a ? ra(b.getTime(), c, d) : e === a ? sa(b, d) : ta(b, e, d);
    };
    nc.delay = function(a, b) {
      return Yb(b) || (b = fc), a instanceof Date ? va(this, a.getTime(), b) : ua(this, a, b);
    }, nc.debounce = function(a, b) {
      Yb(b) || (b = fc);
      var c = this;
      return new Sd(function(d) {
        var e,
      ...
      var d,
          e = this;
      return null == b && (d = a), Yb(c) || (c = fc), "number" == typeof b ? d = b : Yb(b) && (d = a, c = b), new Sd(function(b) {
        function f() {
          var a = new Sb,
              e = !1,
              g = !1;
        ...
        var g,
            ...
            l = new Tb,
            m = 0;
        return g = new Lb(l), h = new Ub(g), k.push(new Vd), b.onNext(Ib(k[0], h)), f(), g.add(e.subscribe(function(a) {
          for (var b = 0,
              c = k.length; c > b; b++)
            k[b].onNext(a);
        }, function(a) {
      ...
      var d = this;
      return Yb(c) || (c = fc), new Sd(function(e) {
        function f(b) {
          var d = new Sb;
          g.setDisposable(d), d.setDisposable(c.scheduleWithRelative(a, function() {
            if (b === k) {
              j = 0;
              var a = ++k;
              l.onCompleted(), l = new Vd, e.onNext(Ib(l, i)), f(a);
            }
          }));
        }
        var g = new Tb,
            ...
            k = 0,
            l = new Vd;
        return e.onNext(Ib(l, i)), f(0), h.add(d.subscribe(function(a) {
          var c = 0,
              d = !1;
          l.onNext(a), ++j === b && (d = !0, j = 0, c = ++k, l.onCompleted(), l = new Vd, e.onNext(Ib(l, i))), d && f(c);
        }, function(a) {
    ...
    }, nc.bufferWithTime = function(a, b, c) {
      ...
      return Yb(a) || (a = fc), this.map(function(b) {
        return {
          value: b,
          timestamp: a.now()
        };
      ...
      return Yb(b) || (b = fc), "number" == typeof a ? wa(this, Rd(a, b)) : wa(this, a);
    }, nc.timeout = function(a, b, c) {
      (null == b || "string" == typeof b) && (b = Zc(new Error(b || "Timeout"))), Yb(c) || (c = fc);
      var d = this,
      ...
      return new Sd(function(f) {
        function g() {
          ...
          l.setDisposable(c[e](a, function() {
            h === d && (Na(b) && (b = Ec(b)), j.setDisposable(b.subscribe(f)));
          }));
        }
        var h = 0,
            i = new Sb,
      ...
      return Yb(f) || (f = fc), new Sd(function(g) {
        var h = !0,
            i = !1;
      ...
      var c = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative",
          d = this;
      return Yb(b) || (b = fc), new Sd(function(e) {
        var f = new Tb;
      ...
      var c,
          e,
          f = this;
      return Oa(a) ? e = a : (c = a, e = b), new Sd(function(a) {
        function b() {
      ...
      1 === arguments.length && (b = a, a = Sc()), c || (c = Zc(new Error("Timeout")));
      var d = this;
      return new Sd(function(e) {
        function f(a) {
          function b() {
      ...
      var c = this;
      return Yb(b) || (b = fc), new Sd(function(d) {
        var e = [];
        return c.subscribe(function(c) {
          var d = b.now();
          for (e.push({
    ...
    }, nc.flatMapFirst = nc.selectManyFirst = function(a, b, c) {
      return new vc(this, a, b, c).switchFirst();
    }, Ga.Observable.prototype.flatMapWithMaxConcurrent = function(a, b, c, d) {
      return new vc(this, b, c, d).merge(a);
    };
    Ga.VirtualTimeScheduler = function(a) {
      function b() {
      ...
      Gb(g, a);
      var h = g.prototype;
      return h.add = $a, h.toDateTimeOffset = $a, h.toRelative = $a, h.schedulePeriodicWithState = function(a, b, c) {
        var d = new _b(this, a, b, c);
        return d.start();
    ...
    Ga.HistoricalScheduler = function(a) {
      function b(b, c) {
        var d = null == b ? 0 : b,
            e = c || La;
        a.call(this, d, e);
    ...
    }(Ga.VirtualTimeScheduler);
    var Sd = Ga.AnonymousObservable = function(a) {
      function b(a) {
        return a && Oa(a.dispose) ? a : Oa(a) ? Ob(a) : Pb;
      }
      function c(a, c) {
      ...
      return Gb(g, a), g;
        ...
        Ud = function(a) {
          ...
          function c(c, d, e) {
            a.call(this, b), this.key = c, this.underlyingObservable = e ? new Sd(function(a) {
              return new Lb(e.getDisposable(), d.subscribe(a));
            }) : d;
          }
          return Gb(c, a), c;
        }(tc),
        Vd = Ga.Subject = function(a) {
          function c(a) {
          ...
          return Gb(d, a), Hb(d.prototype, lc.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            onCompleted: function() {
        ...
        Xd = Ga.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return Gb(c, a), Hb(c.prototype, lc.prototype, {
            onCompleted: function() {
    ...
    Ga.Pauser = function(a) {
      function b() {
        a.call(this);
      }
      return Gb(b, a), b.prototype.pause = function() {
        this.onNext(!1);
      }, b.prototype.resume = function() {
        this.onNext(!0);
      }, b;
    }(Vd), "function" == typeof define && "object" == typeof define.amd && define.amd ? (Fa.Rx = Ga, define(function() {
      return Ga;
    })) : za && Ca ? Da ? (Ca.exports = Ga).Rx = Ga : za.Rx = Ga : Fa.Rx = Ga;
    var Yd = j();
  }).call(this);
})(require("process"));
