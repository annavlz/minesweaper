...
(function(process) {
  (function(a) {
    ...
    function A(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && x(b) ? (b = z(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > _b ? _b : b) : b;
    }
    function B(a, b) {
      this.observer = a, this.parent = b;
    }
    function C(a, b) {
      return ob(a) || (a = sb), new bc(b, a);
    }
    function D(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function G(a, b) {
      return new Ic(function(c) {
        var d = new ib,
            e = new jb;
        return e.setDisposable(d), d.setDisposable(a.subscribe(new nc(c, e, b))), e;
      }, a);
    }
    function H() {
      return !1;
    ...
    var Ya = $.internals.isEqual = function(a, b) {
      return p(a, b, [], []);
        ...
        bb = $.CompositeDisposable = function() {
          var a,
              b,
              c = [];
    ...
    var eb = db.create = function(a) {
      return new db(a);
        ...
        ib = $.SingleAssignmentDisposable = function() {
    ...
    var jb = $.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    ...
    var kb = $.RefCountDisposable = function() {
      function a(a) {
    ...
    var lb = $.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || da, this.disposable = new ib;
    };
    ...
    !function(a) {
      function b(a, b) {
        function c(b) {
          function d(a, b) {
            return g ? f.remove(i) : h = !0, e(b, c), fb;
          }
          var g = !1,
              h = !1,
      ...
      function c(a, b, c) {
        function d(b, e) {
          function h(a, b) {
            return i ? g.remove(k) : j = !0, f(b, d), fb;
          }
          var i = !1,
              j = !1,
              k = a[c](b, e, h);
    ...
    var pb,
        qb,
        rb = ($.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
        ...
        sb = mb.currentThread = function() {
          ...
          function b(b, f) {
            var g = new lb(this, b, f, this.now());
            if (c)
              c.push(g);
            else {
              c = [g];
    ...
    !function() {
      ...
      if (ga(j))
        ...
        Z.addEventListener ? Z.addEventListener("message", c, !1) : Z.attachEvent ? Z.attachEvent("onmessage", c) : Z.onmessage = c, pb = function(a) {
          var b = f++;
        ...
        pb = "document" in Z && "onreadystatechange" in Z.document.createElement("script") ? function(b) {
      ...
      return $a(e, a), e.prototype._clone = function(a) {
        ...
        xb = $.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return ob(a) || (a = rb), new Ic(function(c) {
        ...
        Bb = $.Observer = function() {};
    Bb.prototype.toNotifier = function() {
      var a = this;
      return function(b) {
        return b.accept(a);
      };
    }, Bb.prototype.asObserver = function() {
      var a = this;
      return new Fb(function(b) {
        a.onNext(b);
      }, function(b) {
        a.onError(b);
      }, function() {
    ...
    }, Bb.prototype.checked = function() {
      return new Gb(this);
    };
    var Cb = Bb.create = function(a, b, c) {
      return a || (a = _), b || (b = ea), c || (c = _), new Fb(a, b, c);
    };
    Bb.fromNotifier = function(a, b) {
      var c = za(a, b, 1);
      return new Fb(function(a) {
        return c(yb(a));
      }, function(a) {
        return c(zb(a));
      }, function() {
    ...
    }, Bb.prototype.notifyOn = function(a) {
      return new Ib(a, this);
    }, Bb.prototype.makeSafe = function(a) {
      return new AnonymousSafeObserver(this._onNext, this._onError, this._onCompleted, a);
    };
    var Db,
        Eb = $.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1;
          }
        ...
        Fb = $.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Hb = $.internals.ScheduledObserver = function(a) {
          function b(b, c) {
        ...
        Jb = $.Observable = function() {
          ...
          return Db = b.prototype, b.isObservable = function(a) {
            return a && ga(a.subscribe);
          }, Db.subscribe = Db.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : Cb(a, b, c));
          }, Db.subscribeOnNext = function(a, b) {
            return this._subscribe(Cb("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Db.subscribeOnError = function(a, b) {
            return this._subscribe(Cb(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Db.subscribeOnCompleted = function(a, b) {
            return this._subscribe(Cb(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, b;
        }(),
        Kb = $.ObservableBase = function(a) {
          function b(a) {
            return a && ga(a.dispose) ? a : ga(a) ? eb(a) : fb;
          }
          function c(a, c) {
            var f = c[0],
                g = c[1],
        ...
        Mb = $.internals.Enumerable = function() {},
        Nb = function(a) {
          function b(b) {
          ...
          return $a(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                e = new jb,
                f = rb.scheduleRecursiveWithState(this.sources[ua](), function(f, g) {
                  if (!b) {
    ...
    var Ob = function(a) {
      ...
      return $a(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[ua](),
            e = new jb,
            f = rb.scheduleRecursiveWithState(null, function(f, g) {
              if (!b) {
    ...
    Mb.prototype.catchError = function() {
      return new Ob(this);
    }, Mb.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new Ic(function(c) {
        var e,
            f,
            ...
            k = b[ua](),
            l = new jb,
            m = rb.scheduleRecursive(function(a) {
              if (!e) {
                ...
                var j = new ib,
                    m = new ib;
                l.setDisposable(new bb(m, j)), j.setDisposable(i.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
        ...
        return new bb(j, l, m, eb(function() {
          e = !0;
        }));
      });
    };
    var Pb = function(a) {
      ...
      return $a(b, a), b.prototype[ua] = function() {
        ...
        Sb = Mb.of = function(a, b, c) {
          return new Rb(a, b, c);
        };
    Db.observeOn = function(a) {
      var b = this;
      return new Ic(function(c) {
        return b.subscribe(new Ib(a, c));
      }, b);
    }, Db.subscribeOn = function(a) {
      var b = this;
      return new Ic(function(c) {
        var d = new ib,
            e = new jb;
    ...
    var Tb = function(a) {
      ...
      return $a(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Ub = Jb.fromPromise = function(a) {
          return new Tb(a);
        };
    Db.toPromise = function(a) {
    ...
    var Wb = (Jb.defer = function(a) {
      return new Ic(function(b) {
        ...
        return fa(c) && (c = Ub(c)), c.subscribe(b);
      });
    }, function(a) {
      function b(b) {
      ...
      return $a(b, a), b.prototype.subscribeCore = function(a) {
        ...
        Xb = new Wb(rb),
        Yb = Jb.empty = function(a) {
          return ob(a) || (a = rb), a === rb ? Xb : new Wb(a);
        },
        Zb = function(a) {
          function b(b, c, d) {
    ...
    var ac = Jb.from = function(a, b, c, d) {
      if (null == a)
    ...
    var cc = Jb.fromArray = function(a, b) {
      return ob(b) || (b = sb), new bc(a, b);
    };
    Jb.generate = function(a, b, c, d, e) {
      return ob(e) || (e = sb), new Ic(function(f) {
        var g = !0;
    ...
    D.prototype.run = function() {
      ...
      var b = this.observer,
          ...
          e = d.length;
      return this.parent.scheduler.scheduleRecursiveWithState(0, a);
    }, Jb.pairs = function(a, b) {
      return b || (b = sb), new gc(a, b);
    };
    var hc = function(a) {
      function b(b, c, d) {
    ...
    Jb.range = function(a, b, c) {
      return ob(c) || (c = sb), new hc(a, b, c);
    };
    var jc = function(a) {
      function b(b, c, d) {
    ...
    }, Jb.repeat = function(a, b, c) {
      return ob(c) || (c = sb), new jc(a, b, c);
    };
    var kc = function(a) {
      function b(b, c) {
      ...
      function d(a, b) {
        var c = b[0],
            d = b[1];
        return d.onNext(c), d.onCompleted(), fb;
      }
      return $a(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return this.scheduler === rb ? d(null, a) : this.scheduler.scheduleWithState(a, d);
      }, b;
    }(Kb),
        lc = (Jb["return"] = Jb.just = function(a, b) {
          return ob(b) || (b = rb), new kc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        mc = Jb["throw"] = function(a, b) {
          return ob(b) || (b = rb), new lc(a, b);
        };
    Jb.using = function(a, b) {
      return new Ic(function(c) {
        var e = fb,
            f = d(a)();
        if (f === ha)
          return new bb(mc(f.e).subscribe(c), e);
        f && (e = f);
        var g = d(b)(f);
        return g === ha ? new bb(mc(g.e).subscribe(c), e) : new bb(g.subscribe(c), e);
      });
    }, Db.amb = function(a) {
      var b = this;
      return new Ic(function(c) {
        ...
        return i.setDisposable(b.subscribe(k)), j.setDisposable(a.subscribe(l)), new bb(i, j);
      });
    }, Jb.amb = function() {
      var a,
          b = fc();
    ...
    Db["catch"] = function(a) {
      return ga(a) ? G(this, a) : oc([this, a]);
    };
    var oc = Jb["catch"] = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return Sb(a).catchError();
    };
    Db.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      return Array.isArray(b[0]) ? b[0].unshift(this) : b.unshift(this), pc.apply(this, b);
    };
    var pc = Jb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = ga(b[a - 1]) ? b.pop() : I;
      return Array.isArray(b[0]) && (b = b[0]), new Ic(function(a) {
        function c(b) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new ib;
            fa(f) && (f = Ub(f)), g.setDisposable(f.subscribe(function(a) {
              j[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    Db.concat = function() {
      for (var a = [],
        ...
        a.push(arguments[b]);
      return a.unshift(this), rc.apply(null, a);
    };
    var qc = function(a) {
      function b(b) {
        this.sources = b, a.call(this);
      ...
      return $a(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = rb.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
                  return e.onCompleted();
                var h = c[f];
        ...
        return new bb(b, f, eb(function() {
          a = !0;
        }));
      }, b;
    }(Kb),
        rc = Jb.concat = function() {
          var a;
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
    ...
    var sc = function(a) {
      ...
      return $a(b, a), b.prototype.subscribeCore = function(a) {
        var b = new bb;
        return b.add(this.source.subscribe(new tc(a, this.maxConcurrent, b))), b;
      }, b;
    }(Kb),
        tc = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new ib;
            this.g.add(c), fa(a) && (a = Ub(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    Db.merge = function(a) {
      return "number" != typeof a ? uc(this, a) : new sc(this, a);
    };
    var uc = Jb.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
    ...
    vc.prototype = Error.prototype, Jb.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return new Ic(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : 1 === g.length ? a.onError(g[0]) : a.onError(new vc(g));
        }
        var c = new bb,
            e = new ib,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new ib;
          c.add(e), fa(d) && (d = Ub(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    var wc = function(a) {
      ...
      return $a(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new ib;
          this.g.add(b), fa(a) && (a = Ub(a)), b.setDisposable(a.subscribe(new d(this, b)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    Db.mergeAll = function() {
      return new wc(this);
    }, Db.onErrorResumeNext = function(a) {
      if (!a)
        throw new Error("Second observable is required");
      return xc([this, a]);
    };
    var xc = Jb.onErrorResumeNext = function() {
      var a = [];
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else
      ...
      return new Ic(function(b) {
        var c = 0,
            ...
            e = rb.scheduleRecursive(function(e) {
              var f,
                  g;
              c < a.length ? (f = a[c++], fa(f) && (f = Ub(f)), g = new ib, d.setDisposable(g), g.setDisposable(f.subscribe(b.onNext.bind(b), e, e))) : b.onCompleted();
            });
        return new bb(d, e);
      });
    };
    Db.skipUntil = function(a) {
      var b = this;
      return new Ic(function(c) {
        var d = !1,
    ...
    var yc = function(a) {
      ...
      return $a(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new ib,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), fa(a) && (a = Ub(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    Db["switch"] = Db.switchLatest = function() {
      return new yc(this);
    };
    var zc = function(a) {
      function b(b, c) {
        this.source = b, this.other = fa(c) ? Ub(c) : c, a.call(this);
      }
      function c(a) {
        this.o = a, this.isStopped = !1;
      }
      return $a(b, a), b.prototype.subscribeCore = function(a) {
        return new bb(this.source.subscribe(a), this.other.subscribe(new c(a)));
      }, c.prototype.onNext = function(a) {
    ...
    Db.takeUntil = function(a) {
      return new zc(this, a);
    }, Db.withLatestFrom = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Ic(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new ib;
            fa(d) && (d = Ub(d)), e.setDisposable(d.subscribe(function(a) {
      ...
      var f = this;
      return b.unshift(f), new Ic(function(a) {
        for (var c = b.length,
            g = q(c, J),
            h = q(c, H),
            i = new Array(c),
          ...
          !function(c) {
            var j = b[c],
                k = new ib;
            fa(j) && (j = Ub(j)), k.setDisposable(j.subscribe(function(b) {
      ...
      return b.unshift(f), new Ic(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var j = b[c],
                k = new ib;
            (xa(j) || wa(j)) && (j = ac(j)), k.setDisposable(j.subscribe(function(b) {
              if (g[c].push(b), g.every(function(a) {
                return a.length > 0;
              })) {
                var i = g.map(function(a) {
    ...
    }, Db.asObservable = function() {
      return new Ic(K(this), this);
    }, Db.bufferWithCount = function(a, b) {
      return "number" != typeof b && (b = a), this.windowWithCount(a, b).flatMap(L).filter(M);
    }, Db.dematerialize = function() {
      var a = this;
      return new Ic(function(b) {
    ...
    var Ac = function(a) {
      ...
      return $a(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new Bc(a, this.keyFn, this.comparer));
      }, b;
    }(Kb),
        Bc = function(a) {
          function b(b, c, d) {
    ...
    Db.distinctUntilChanged = function(a, b) {
      return b || (b = ca), new Ac(this, a, b);
    };
    var Cc = function(a) {
      function b(b, c, d, e) {
      ...
      function c(a, b) {
        this.o = a, this.t = !b._oN || ga(b._oN) ? Cb(b._oN || _, b._oE || _, b._oC || _) : b._oN, this.isStopped = !1;
      }
      return $a(b, a), b.prototype.subscribeCore = function(a) {
    ...
    Db["do"] = Db.tap = Db.doAction = function(a, b, c) {
      return new Cc(this, a, b, c);
    }, Db.doOnNext = Db.tapOnNext = function(a, b) {
      return this.tap("undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Db.doOnError = Db.tapOnError = function(a, b) {
      return this.tap(_, "undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Db.doOnCompleted = Db.tapOnCompleted = function(a, b) {
      return this.tap(_, null, "undefined" != typeof b ? function() {
        a.call(b);
      } : a);
    }, Db["finally"] = function(a) {
      var b = this;
      return new Ic(function(c) {
        var f = d(b.subscribe).call(b, c);
        return f === ha ? (a(), e(f.e)) : eb(function() {
    ...
    Db.ignoreElements = function() {
      return new Dc(this);
    }, Db.materialize = function() {
      var a = this;
      return new Ic(function(b) {
        return a.subscribe(function(a) {
          b.onNext(yb(a));
    ...
    }, Db.repeat = function(a) {
      return Qb(this, a).concat();
    }, Db.retry = function(a) {
      return Qb(this, a).catchError();
    }, Db.retryWhen = function(a) {
      return Qb(this).catchErrorWhen(a);
    };
    var Ec = function(a) {
      function b(b, c, d, e) {
    ...
    N.prototype = {
      ...
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new Ec(this, c, b, a);
    }, Db.skipLast = function(a) {
      if (0 > a)
        throw new pa;
      var b = this;
      return new Ic(function(c) {
      ...
      for (var c = [],
        ...
        c.push(arguments[d]);
      return Sb([cc(c, a), this]).concat();
    }, Db.takeLast = function(a) {
      if (0 > a)
        throw new pa;
      var b = this;
      return new Ic(function(c) {
    ...
    }, Db.windowWithCount = function(a, b) {
      var c = this;
    ...
    }, Db.flatMapConcat = Db.concatMap = function(a, b, c) {
      return new Lb(this, a, b, c).merge(1);
    }, Db.concatMapObserver = Db.selectConcatObserver = function(a, b, c, d) {
      var e = this,
          f = za(a, d, 2),
          g = za(b, d, 1),
          h = za(c, d, 0);
      return new Ic(function(a) {
        ...
        return e.subscribe(function(c) {
          ...
          fa(c) && (c = Ub(c)), a.onNext(c), a.onCompleted();
        }, function() {
          var b;
          try {
            b = h();
          ...
          fa(b) && (b = Ub(b)), a.onNext(b), a.onCompleted();
        });
      }, this).concatAll();
    }, Db.defaultIfEmpty = function(b) {
      var c = this;
    ...
    }, Db.distinct = function(a, b) {
      var c = this;
      return b || (b = ca), new Ic(function(d) {
        var e = new P(b);
        return c.subscribe(function(b) {
          var c = b;
          if (a)
    ...
    Db.map = Db.select = function(a, b) {
      var c = "function" == typeof a ? a : function() {
        return a;
      };
      return this instanceof Fc ? this.internalMap(c, b) : new Fc(this, c, b);
    }, Db.pluck = function() {
    ...
    }, Db.flatMapObserver = Db.selectManyObserver = function(a, b, c, d) {
      var e = this;
      return new Ic(function(f) {
        ...
        return e.subscribe(function(b) {
          ...
          fa(c) && (c = Ub(c)), f.onNext(c), f.onCompleted();
        }, function() {
          var a;
          try {
            a = c.call(d);
          ...
          fa(a) && (a = Ub(a)), f.onNext(a), f.onCompleted();
        });
      }, e).mergeAll();
    }, Db.flatMap = Db.selectMany = function(a, b, c) {
      return new Lb(this, a, b, c).mergeAll();
    }, $.Observable.prototype.flatMapLatest = function(a, b, c) {
      return new Lb(this, a, b, c).switchLatest();
    };
    var Gc = function(a) {
      function b(b, c) {
    ...
    Db.filter = Db.where = function(a, b) {
      return this instanceof Hc ? this.internalFilter(a, b) : new Hc(this, a, b);
    }, Db.transduce = function(a) {
      function b(a) {
        return {
    ...
    var Ic = $.AnonymousObservable = function(a) {
      function b(a) {
        return a && ga(a.dispose) ? a : ga(a) ? eb(a) : fb;
      }
      function c(a, c) {
    ...
    var Lc = $.Subject = function(a) {
      function c(a) {
        return hb(this), this.isStopped ? this.hasError ? (a.onError(this.error), fb) : (a.onCompleted(), fb) : (this.observers.push(a), new Kc(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return $a(d, a), _a(d.prototype, Bb.prototype, {
        ...
        Mc = ($.AsyncSubject = function(a) {
          function c(a) {
            return hb(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), fb) : (this.observers.push(a), new Kc(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return $a(d, a), _a(d.prototype, Bb, {
            hasObservers: function() {
        ...
        }(Jb), $.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return $a(c, a), _a(c.prototype, Bb.prototype, {
            onCompleted: function() {
