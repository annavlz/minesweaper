...
(function(process) {
  (function(a) {
    ...
    function l(a) {
      ...
      if (!gb(a))
        return b;
      fb.nonEnumArgs && a.length && hb(a) && (a = jb.call(a));
      var c = fb.enumPrototypes && "function" == typeof a,
          d = fb.enumErrorProps && (a === _a || a instanceof Error);
      for (var e in a)
        c && "prototype" == e || d && ("message" == e || "name" == e) || b.push(e);
      if (fb.nonEnumShadows && a !== ab) {
        var f = a.constructor,
            g = -1,
            h = Na;
        if (a === (f && f.prototype))
          var i = a === bb ? Xa : a === _a ? Sa : Ya.call(a),
              j = eb[i];
        for (; ++g < h; )
          e = Ma[g], j && j[e] || !Za.call(a, e) || b.push(e);
      }
      return b;
    }
    function m(a, b, c) {
    ...
    function p(a, b, c, d) {
      ...
      var i = g == Pa;
      if (!i) {
        if (g != Va || !fb.nodeClass && (o(a) || o(b)))
          return !1;
        var j = !fb.argsObject && hb(a) ? Object : a.constructor,
            k = !fb.argsObject && hb(b) ? Object : b.constructor;
        if (!(j == k || Za.call(a, "constructor") && Za.call(b, "constructor") || sa(j) && j instanceof j && sa(k) && k instanceof k || !("constructor" in a && "constructor" in b)))
          return !1;
      }
      c || (c = []), d || (d = []);
      ...
      if (c.push(a), d.push(b), i) {
        ...
        n(b, function(b, e, f) {
          return Za.call(f, e) ? (m++, q = Za.call(a, e) && p(a[e], b, c, d)) : void 0;
        }), q && n(a, function(a, b, c) {
          return Za.call(c, b) ? q = --m > -1 : void 0;
        });
    ...
    function v(a) {
      return "number" == typeof a && ja.isFinite(a);
    }
    function w(b) {
      var c,
          d = b[Ga];
      if (!d && "string" == typeof b)
        return c = new r(b), c[Ga]();
      if (!d && b.length !== a)
        return c = new t(b), c[Ga]();
      if (!d)
    ...
    function y(a) {
      var b = +a.length;
      return isNaN(b) ? 0 : 0 !== b && v(b) ? (b = x(b) * Math.floor(Math.abs(b)), 0 >= b ? 0 : b > ic ? ic : b) : b;
    }
    function z(a, b) {
      this.observer = a, this.parent = b;
    }
    function A(a, b) {
      return Ab(a) || (a = Eb), new kc(b, a);
    }
    function B(a, b) {
      this.observer = a, this.parent = b;
    }
    ...
    function D(a, b) {
      return new Yc(function(c) {
        var d = new vb,
            e = new wb;
        return e.setDisposable(d), d.setDisposable(a.subscribe(new vc(c, e, b))), e;
      }, a);
    }
    function E() {
      return !1;
    ...
    function T(a, b, c) {
      return a.addEventListener ? new Q(a, b, c) : a.attachEvent ? new R(a, b, c) : S(a, b, c);
    }
    function U(a, b, c) {
      var d = new ob;
      if (O(a) || "[object HTMLCollection]" === Object.prototype.toString.call(a))
        for (var e = 0,
            f = a.length; f > e; e++)
          d.add(U(a.item(e), b, c));
      else
        a && d.add(T(a, b, c));
      return d;
    }
    ...
    function X(a, b) {
      return new Yc(function(c) {
        return b.scheduleWithRelative(zb(a), function() {
          c.onNext(0), c.onCompleted();
        });
      });
    }
    ...
    function Z(a, b, c) {
      return new Yc(function(d) {
        ...
        return e = a.materialize().timestamp(c).subscribe(function(a) {
          ...
          }), k = !f, f = !0), k && (null !== h ? d.onError(h) : (e = new vb, g.setDisposable(e), e.setDisposable(c.scheduleRecursiveWithRelative(b, function(a) {
            var b,
                e,
                g,
                k;
 ...
 while (null !== g);
    ...
    function _(a, b) {
      return new Yc(function(c) {
        ...
        return h.setDisposable(a.subscribe(function(a) {
          ...
          f = !0, h.dispose();
        })), new ob(h, b.subscribe(d, function(a) {
          c.onError(a);
        }, d));
      }, a);
    }
    function aa(a, b, c) {
      return new Yc(function(e) {
        function f(a, b) {
          if (k[b] = a, h[b] = !0, i || (i = h.every(ma))) {
            if (g)
              return e.onError(g);
        ...
        var g,
            ...
            j = !1,
            k = new Array(2);
        return new ob(a.subscribe(function(a) {
          f(a, 0);
        }, function(a) {
          k[1] ? e.onError(a) : g = a;
        }, function() {
    ...
    var ba,
        ...
        da = ca[typeof exports] && exports && !exports.nodeType && exports,
        ea = ca[typeof self] && self.Object && self,
        fa = ca[typeof window] && window && window.Object && window,
        ga = ca[typeof module] && module && !module.nodeType && module,
        ha = ga && ga.exports === da && da,
        ia = da && ga && "object" == typeof global && global && global.Object && global,
        ja = ja = ia || fa !== (this && this.window) && fa || ea || this,
        ka = {
          internals: {},
          config: {Promise: ja.Promise},
          helpers: {}
        },
        la = ka.helpers.noop = function() {},
        ma = ka.helpers.identity = function(a) {
          return a;
        },
        na = ka.helpers.defaultNow = function() {
          return Date.now ? Date.now : function() {
            return +new Date;
          };
        }(),
        oa = ka.helpers.defaultComparer = function(a, b) {
          return ib(a, b);
        },
        pa = ka.helpers.defaultSubComparer = function(a, b) {
          return a > b ? 1 : b > a ? -1 : 0;
        },
        qa = (ka.helpers.defaultKeySerializer = function(a) {
          return a.toString();
        }, ka.helpers.defaultError = function(a) {
          throw a;
        }),
        ra = ka.helpers.isPromise = function(a) {
          return !!a && "function" != typeof a.subscribe && "function" == typeof a.then;
        },
        sa = ka.helpers.isFunction = function() {
          var a = function(a) {
    ...
    var wa,
        ...
        za = ka.EmptyError = function() {
          this.message = "Sequence contains no elements.", this.name = "EmptyError", Error.call(this);
        };
    za.prototype = Error.prototype;
    var Aa = ka.ObjectDisposedError = function() {
      this.message = "Object has been disposed", this.name = "ObjectDisposedError", Error.call(this);
    };
    Aa.prototype = Error.prototype;
    var Ba = ka.ArgumentOutOfRangeError = function() {
      this.message = "Argument out of range", this.name = "ArgumentOutOfRangeError", Error.call(this);
    };
    Ba.prototype = Error.prototype;
    var Ca = ka.NotSupportedError = function(a) {
      this.message = a || "This operation is not supported", this.name = "NotSupportedError", Error.call(this);
    };
    Ca.prototype = Error.prototype;
    var Da = ka.NotImplementedError = function(a) {
      this.message = a || "This operation is not implemented", this.name = "NotImplementedError", Error.call(this);
    };
    Da.prototype = Error.prototype;
    var Ea = ka.helpers.notImplemented = function() {
      throw new Da;
    },
        Fa = ka.helpers.notSupported = function() {
          throw new Ca;
        },
        Ga = "function" == typeof Symbol && Symbol.iterator || "_es6shim_iterator_";
    ja.Set && "function" == typeof(new ja.Set)["@@iterator"] && (Ga = "@@iterator");
    var Ha = ka.doneEnumerator = {
      done: !0,
      value: a
    },
        Ia = ka.helpers.isIterable = function(b) {
          return b[Ga] !== a;
        },
        Ja = ka.helpers.isArrayLike = function(b) {
          return b && b.length !== a;
        };
    ka.helpers.iterator = Ga;
    var Ka,
        La = ka.internals.bindCallback = function(a, b, c) {
    ...
    !function() {
      ...
      for (c in arguments)
        ;
      fb.enumErrorProps = cb.call(_a, "message") || cb.call(_a, "name"), fb.enumPrototypes = cb.call(a, "prototype"), fb.nonEnumArgs = 0 != c, fb.nonEnumShadows = !/valueOf/.test(b);
    }(1);
    var gb = ka.internals.isObject = function(a) {
      var b = typeof a;
    ...
    var ib = ka.internals.isEqual = function(a, b) {
      return p(a, b, [], []);
    },
        jb = ({}.hasOwnProperty, Array.prototype.slice),
        kb = ka.internals.inherits = function(a, b) {
          function c() {
            this.constructor = a;
          }
          c.prototype = b.prototype, a.prototype = new c;
        },
        lb = ka.internals.addProperties = function(a) {
          for (var b = [],
              c = 1,
    ...
    ka.internals.addRef = function(a, b) {
      return new Yc(function(c) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(a) {
      var b = this,
          c = jb.call(arguments, 1),
          d = function() {
            function e() {}
            if (this instanceof d) {
              e.prototype = b.prototype;
              var f = new e,
                  g = b.apply(f, c.concat(jb.call(arguments)));
              return Object(g) === g ? g : f;
            }
            return b.apply(a, c.concat(jb.call(arguments)));
          };
      return d;
    ...
    Array.prototype.every || (Array.prototype.every = function(a) {
      var b = Object(this),
          c = nb && {}.toString.call(this) == Xa ? this.split("") : b,
          d = c.length >>> 0,
          e = arguments[1];
      if ({}.toString.call(a) != Ta)
        throw new TypeError(a + " is not a function");
      for (var f = 0; d > f; f++)
      ...
      return function(c) {
        ...
        if (b)
          for (e = 0; Na > e; e++)
            a.call(c, Ma[e]) && f.push(Ma[e]);
        return f;
      };
    }());
    var ob = ka.CompositeDisposable = function() {
      var a,
          b,
          c = [];
    ...
    var qb = ka.Disposable = function(a) {
      this.isDisposed = !1, this.action = a || la;
    };
    ...
    var rb = qb.create = function(a) {
      return new qb(a);
        ...
        sb = qb.empty = {dispose: la},
        tb = qb.isDisposable = function(a) {
          return a && sa(a.dispose);
        },
        ub = qb.checkDisposed = function(a) {
          if (a.isDisposed)
            throw new Aa;
        },
        vb = ka.SingleAssignmentDisposable = function() {
    ...
    var wb = ka.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    ...
    var xb = (ka.RefCountDisposable = function() {
      function a(a) {
    ...
    }(), ka.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || pa, this.disposable = new vb;
    });
    xb.prototype.invoke = function() {
      this.disposable.setDisposable(this.invokeCore());
    }, xb.prototype.compareTo = function(a) {
      return this.comparer(this.dueTime, a.dueTime);
    }, xb.prototype.isCancelled = function() {
      return this.disposable.isDisposed;
    }, xb.prototype.invokeCore = function() {
      return this.action(this.scheduler, this.state);
    };
    var yb = ka.Scheduler = function() {
      function a(a, b, c, d) {
      ...
      }, a.now = na, a.normalize = function(a) {
        return 0 > a && (a = 0), a;
      }, a;
    }(),
        zb = yb.normalize,
    ...
    !function(a) {
      function b(a, b) {
        function c(b) {
          function d(a, b) {
            return g ? f.remove(i) : h = !0, e(b, c), sb;
          }
          var g = !1,
              h = !1,
      ...
      function c(a, b, c) {
        function d(b, e) {
          function h(a, b) {
            return i ? g.remove(k) : j = !0, f(b, d), sb;
          }
          var i = !1,
              j = !1,
              k = a[c](b, e, h);
    ...
    }(yb.prototype), function(a) {
      yb.prototype.schedulePeriodic = function(a, b) {
        return this.schedulePeriodicWithState(null, a, b);
      }, yb.prototype.schedulePeriodicWithState = function(a, b, c) {
        if ("undefined" == typeof ja.setInterval)
          throw new Ca;
        b = zb(b);
        var d = a,
            e = ja.setInterval(function() {
              d = c(d);
            }, b);
        return rb(function() {
          ja.clearInterval(e);
    ...
    var Bb,
        Cb,
        Db = yb.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new yb(na, a, Fa, Fa);
        }(),
        Eb = yb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.shift();
          ...
          function b(b, f) {
            var g = new xb(this, b, f, this.now());
            if (c)
              c.push(g);
            else {
              c = [g];
        ...
        Fb = (ka.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
          ...
          var a,
              b = la;
          if (ja.setTimeout)
            a = ja.setTimeout, b = ja.clearTimeout;
          else {
            if (!ja.WScript)
              throw new Ca;
            a = function(a, b) {
              ja.WScript.Sleep(b), a();
            };
          }
          return {
            setTimeout: a,
    ...
    !function() {
      ...
      function b() {
        if (!ja.postMessage || ja.importScripts)
          return !1;
        var a = !1,
            b = ja.onmessage;
        return ja.onmessage = function() {
          a = !0;
        }, ja.postMessage("", "*"), ja.onmessage = b, a;
      }
      function c(b) {
      ...
      var i = RegExp("^" + String(Ya).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
          j = "function" == typeof(j = ia && ha && ia.setImmediate) && !i.test(j) && j;
      if (sa(j))
        Bb = function(b) {
          var c = f++;
        ...
        ja.addEventListener ? ja.addEventListener("message", c, !1) : ja.attachEvent ? ja.attachEvent("onmessage", c) : ja.onmessage = c, Bb = function(a) {
          var b = f++;
          return g[b] = a, ja.postMessage(k + currentId, "*"), b;
        };
      } else if (ja.MessageChannel) {
        var l = new ja.MessageChannel;
        ...
        Bb = "document" in ja && "onreadystatechange" in ja.document.createElement("script") ? function(b) {
          var c = ja.document.createElement("script"),
              d = f++;
          return g[d] = b, c.onreadystatechange = function() {
            a(d), c.onreadystatechange = null, c.parentNode.removeChild(c), c = null;
          }, ja.document.documentElement.appendChild(c), d;
        } : function(b) {
          var c = f++;
          return g[c] = b, Gb(function() {
            a(c);
          }, 0), c;
        };
    }();
    var Ib,
        Jb = yb.timeout = yb["default"] = function() {
          function a(a, b) {
            var c = this,
                d = new vb,
                e = Bb(function() {
          ...
          return new yb(na, a, b, c);
        }(),
        Kb = ka.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return Ab(a) || (a = Db), new Yc(function(c) {
        ...
        Lb = Kb.createOnNext = function() {
          ...
          return function(d) {
            return new Kb("N", d, null, a, b, c);
          };
        }(),
        Mb = Kb.createOnError = function() {
          function a(a, b) {
          ...
          return function(d) {
            return new Kb("E", null, d, a, b, c);
          };
        }(),
        Nb = Kb.createOnCompleted = function() {
          function a(a, b, c) {
            return c();
          }
          function b(a) {
          ...
          return function() {
            return new Kb("C", null, null, a, b, c);
          };
        }(),
        Ob = ka.Observer = function() {},
        Pb = Ob.create = function(a, b, c) {
          return a || (a = la), b || (b = qa), c || (c = la), new Rb(a, b, c);
        },
        Qb = ka.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1;
          }
        ...
        Rb = ka.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Sb = ka.Observable = function() {
          ...
          function b(b) {
            if (ka.config.longStackSupport && ua) {
              var c = d(e)(new Error).e;
              this.stack = c.stack.substring(c.stack.indexOf("\n") + 1), this._subscribe = a(this, b);
            } else
              this._subscribe = b;
          }
          return Ib = b.prototype, b.isObservable = function(a) {
            return a && sa(a.subscribe);
          }, Ib.subscribe = Ib.forEach = function(a, b, c) {
            return this._subscribe("object" == typeof a ? a : Pb(a, b, c));
          }, Ib.subscribeOnNext = function(a, b) {
            return this._subscribe(Pb("undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Ib.subscribeOnError = function(a, b) {
            return this._subscribe(Pb(null, "undefined" != typeof b ? function(c) {
              a.call(b, c);
            } : a));
          }, Ib.subscribeOnCompleted = function(a, b) {
            return this._subscribe(Pb(null, null, "undefined" != typeof b ? function() {
              a.call(b);
            } : a));
          }, b;
        }(),
        Tb = ka.ObservableBase = function(a) {
          function b(a) {
            return a && sa(a.dispose) ? a : sa(a) ? rb(a) : sb;
          }
          function c(a, c) {
            var f = c[0],
                g = c[1],
                h = d(g.subscribeCore).call(g, f);
            return h !== ta || f.fail(ta.e) ? void f.setDisposable(b(h)) : e(ta.e);
          }
          function f(a) {
            var b = new Zc(a),
                d = [b, this];
            return Eb.scheduleRequired() ? Eb.scheduleWithState(d, c) : c(null, d), b;
          }
          function g() {
            a.call(this, f);
          }
          return kb(g, a), g.prototype.subscribeCore = Ea, g;
        }(Sb),
        Ub = function(a) {
          function b(b, c, d, e) {
            this.resultSelector = ka.helpers.isFunction(d) ? d : null, this.selector = ka.internals.bindCallback(ka.helpers.isFunction(c) ? c : function() {
              return c;
          ...
          return kb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              ...
              ka.helpers.isPromise(c) && (c = ka.Observable.fromPromise(c)), (ka.helpers.isArrayLike(c) || ka.helpers.isIterable(c)) && (c = ka.Observable.from(c)), this.o.onNext(this._wrapResult(c, a, b));
            }
        ...
        Vb = ka.internals.Enumerable = function() {},
        Wb = function(a) {
          function b(b) {
          ...
          return kb(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                e = new wb,
                f = Db.scheduleRecursiveWithState(this.sources[Ga](), function(f, g) {
                  if (!b) {
    ...
    var Xb = function(a) {
      ...
      return kb(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[Ga](),
            e = new wb,
            f = Db.scheduleRecursiveWithState(null, function(f, g) {
              if (!b) {
    ...
    Vb.prototype.catchError = function() {
      return new Xb(this);
    }, Vb.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new Yc(function(c) {
        var e,
            f,
            ...
            k = b[Ga](),
            l = new wb,
            m = Db.scheduleRecursive(function(a) {
              if (!e) {
                ...
                var j = new vb,
                    m = new vb;
                l.setDisposable(new ob(m, j)), j.setDisposable(i.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
        ...
        return new ob(j, l, m, rb(function() {
          e = !0;
        }));
      });
    };
    var Yb = function(a) {
      ...
      return kb(b, a), b.prototype[Ga] = function() {
        ...
        return 0 === this.l ? Ha : (this.l > 0 && this.l--, {
          done: !1,
          value: this.v
        });
      }, b;
    }(Vb),
        Zb = Vb.repeat = function(a, b) {
          return new Yb(a, b);
        },
        $b = function(a) {
          function b(a, b, c) {
        ...
        _b = Vb.of = function(a, b, c) {
          return new $b(a, b, c);
        },
        ac = ka.internals.ScheduledObserver = function(a) {
          function b(b, c) {
          ...
          return kb(b, a), b.prototype.next = function(a) {
            ...
            !this.hasFaulted && this.queue.length > 0 && (a = !this.isAcquired, this.isAcquired = !0), a && this.disposable.setDisposable(this.scheduler.scheduleRecursiveWithState(this, function(a, b) {
              ...
              c = a.queue.shift();
              var f = d(c)();
              return f === ta ? (a.queue = [], a.hasFaulted = !0, e(f.e)) : void b(a);
            }));
          }, b.prototype.dispose = function() {
    ...
    Ib.toArray = function() {
      return new bc(this);
    }, Sb.create = function(a, b) {
      return new Yc(a, b);
    };
    var cc = Sb.defer = function(a) {
      return new Yc(function(b) {
        var c;
        try {
          c = a();
        } catch (d) {
          return uc(d).subscribe(b);
        }
        return ra(c) && (c = Rc(c)), c.subscribe(b);
      });
    },
        dc = function(a) {
          function b(b) {
        ...
        ec = new dc(Db),
        fc = Sb.empty = function(a) {
          return Ab(a) || (a = Db), a === Db ? ec : new dc(a);
        },
        gc = function(a) {
          function b(b, c, d) {
        ...
        hc = function() {
          ...
          return a.prototype.run = function() {
            function a(a, b) {
              ...
              var h = g.value;
              return sa(f) && (h = d(f)(h, a), h === ta) ? e.onError(h.e) : (e.onNext(h), void b(a + 1));
            }
    ...
    var jc = Sb.from = function(a, b, c, d) {
      if (null == a)
    ...
    var lc = Sb.fromArray = function(a, b) {
      return Ab(b) || (b = Eb), new kc(a, b);
    },
        mc = function(a) {
          function b() {
            a.call(this);
    ...
    B.prototype.run = function() {
      ...
      var b = this.observer,
          ...
          e = d.length;
      return this.parent.scheduler.scheduleRecursiveWithState(0, a);
    }, Sb.pairs = function(a, b) {
      return b || (b = Eb), new oc(a, b);
    };
    var pc = function(a) {
      function b(b, c, d) {
    ...
    Sb.range = function(a, b, c) {
      return Ab(c) || (c = Eb), new pc(a, b, c);
    };
    var rc = function(a) {
      function b(b, c, d) {
    ...
    }, Sb.repeat = function(a, b, c) {
      return Ab(c) || (c = Eb), new rc(a, b, c);
    };
    var sc = function(a) {
      function b(b, c) {
      ...
      function d(a, b) {
        var c = b[0],
            d = b[1];
        return d.onNext(c), d.onCompleted(), sb;
      }
      return kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return this.scheduler === Db ? d(null, a) : this.scheduler.scheduleWithState(a, d);
      }, b;
    }(Tb),
        tc = (Sb["return"] = Sb.just = function(a, b) {
          return Ab(b) || (b = Db), new sc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        uc = Sb["throw"] = function(a, b) {
          return Ab(b) || (b = Db), new tc(a, b);
        },
        vc = function(a) {
          function b(b, c, d) {
    ...
    Ib["catch"] = function(a) {
      return sa(a) ? D(this, a) : wc([this, a]);
    };
    var wc = Sb["catch"] = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
    ...
    Ib.combineLatest = function() {
      for (var a = arguments.length,
          ...
          c = 0; a > c; c++)
        b[c] = arguments[c];
      return Array.isArray(b[0]) ? b[0].unshift(this) : b.unshift(this), xc.apply(this, b);
    };
    var xc = Sb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = sa(b[a - 1]) ? b.pop() : F;
      return Array.isArray(b[0]) && (b = b[0]), new Yc(function(a) {
        function c(b) {
          if (g[b] = !0, h || (h = g.every(ma))) {
            try {
            ...
            i.filter(function(a, c) {
              return c !== b;
            }).every(ma) && a.onCompleted();
        }
        function e(b) {
          i[b] = !0, i.every(ma) && a.onCompleted();
        }
        for (var f = b.length,
            g = q(f, E),
            h = !1,
          ...
          !function(d) {
            var f = b[d],
                g = new vb;
            ra(f) && (f = Rc(f)), g.setDisposable(f.subscribe(function(a) {
              j[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    Ib.concat = function() {
      for (var a = [],
        ...
        a.push(arguments[b]);
      return a.unshift(this), zc.apply(null, a);
    };
    var yc = function(a) {
      function b(b) {
        this.sources = b, a.call(this);
      ...
      return kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = Db.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
                  return e.onCompleted();
                var h = c[f];
        ...
        return new ob(b, f, rb(function() {
          a = !0;
        }));
      }, b;
    }(Tb),
        zc = Sb.concat = function() {
          var a;
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
    ...
    var Ac = function(a) {
      ...
      return kb(b, a), b.prototype.subscribeCore = function(a) {
        var b = new ob;
        return b.add(this.source.subscribe(new Bc(a, this.maxConcurrent, b))), b;
      }, b;
    }(Tb),
        Bc = function() {
          function a(a, b, c) {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new vb;
            this.g.add(c), ra(a) && (a = Rc(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    Ib.merge = function(a) {
      return "number" != typeof a ? Cc(this, a) : new Ac(this, a);
    };
    var Cc = Sb.merge = function() {
      var a,
          b,
          c = [],
          d = arguments.length;
      ...
      return Array.isArray(c[0]) && (c = c[0]), A(a, c).mergeAll();
        ...
        Dc = function(a) {
          ...
          return kb(b, a), b.prototype.subscribeCore = function(a) {
            ...
            if (!this.isStopped) {
              var b = new vb;
              this.g.add(b), ra(a) && (a = Rc(a)), b.setDisposable(a.subscribe(new d(this, b)));
            }
          }, c.prototype.onError = function(a) {
            this.isStopped || (this.isStopped = !0, this.o.onError(a));
          }, c.prototype.onCompleted = function() {
    ...
    Ib.mergeAll = function() {
      return new Dc(this);
    };
    var Ec = ka.CompositeError = function(a) {
    ...
    Ec.prototype = Error.prototype, Sb.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      var d = A(null, a);
      return new Yc(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : 1 === g.length ? a.onError(g[0]) : a.onError(new Ec(g));
        }
        var c = new ob,
            e = new vb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new vb;
          c.add(e), ra(d) && (d = Rc(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    var Fc = function(a) {
      ...
      return kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new vb,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), ra(a) && (a = Rc(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    var Gc = function(a) {
      function b(b, c) {
        this.source = b, this.other = ra(c) ? Rc(c) : c, a.call(this);
      }
      function c(a) {
        this.o = a, this.isStopped = !1;
      }
      return kb(b, a), b.prototype.subscribeCore = function(a) {
        return new ob(this.source.subscribe(a), this.other.subscribe(new c(a)));
      }, c.prototype.onNext = function(a) {
    ...
    Ib.takeUntil = function(a) {
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Yc(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new vb;
            ra(d) && (d = Rc(d)), e.setDisposable(d.subscribe(function(a) {
              i[c] = a, g[c] = !0, h = g.every(ma);
            }, function(b) {
              a.onError(b);
            }, la)), j[c] = e;
          }(k);
        ...
        return l.setDisposable(f.subscribe(function(b) {
          ...
          if (h) {
            ...
            return f === ta ? a.onError(f.e) : void a.onNext(f);
          }
        }, function(b) {
          a.onError(b);
        }, function() {
      ...
      for (var a = arguments.length,
          ...
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var e = sa(b[a - 1]) ? b.pop() : F;
      Array.isArray(b[0]) && (b = b[0]);
      var f = this;
      return b.unshift(f), new Yc(function(a) {
        for (var c = b.length,
            g = q(c, G),
            h = q(c, E),
            i = new Array(c),
          ...
          !function(c) {
            var j = b[c],
                k = new vb;
            ra(j) && (j = Rc(j)), k.setDisposable(j.subscribe(function(b) {
              ...
              h[c] = !0, h.every(ma) && a.onCompleted();
            })), i[c] = k;
          }(j);
        return new ob(i);
      }, f);
      ...
      return b.unshift(f), new Yc(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var j = b[c],
                k = new vb;
            (Ja(j) || Ia(j)) && (j = jc(j)), k.setDisposable(j.subscribe(function(b) {
              if (g[c].push(b), g.every(function(a) {
                return a.length > 0;
              })) {
                var i = g.map(function(a) {
    ...
    var Hc = function(a) {
      ...
      return kb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new Ic(a, this.keyFn, this.comparer));
      }, b;
    }(Tb),
        Ic = function(a) {
          function b(b, c, d) {
          ...
          return kb(b, a), b.prototype.next = function(a) {
            var b,
                c = a;
            return sa(this.keyFn) && (c = d(this.keyFn)(a), c === ta) ? this.o.onError(c.e) : this.hasCurrentKey && (b = d(this.comparer)(this.currentKey, c), b === ta) ? this.o.onError(b.e) : void(this.hasCurrentKey && b || (this.hasCurrentKey = !0, this.currentKey = c, this.o.onNext(a)));
          }, b.prototype.error = function(a) {
            this.o.onError(a);
          }, b.prototype.completed = function() {
            this.o.onCompleted();
    ...
    var Jc = function(a) {
      ...
      function c(a, b) {
        this.o = a, this.t = !b._oN || sa(b._oN) ? Pb(b._oN || la, b._oE || la, b._oC || la) : b._oN, this.isStopped = !1;
      }
      return kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          ...
          b === ta && this.o.onError(b.e), this.o.onNext(a);
        }
      }, c.prototype.onError = function(a) {
        if (!this.isStopped) {
          this.isStopped = !0;
    ...
    Ib["do"] = Ib.tap = Ib.doAction = function(a, b, c) {
      ...
      return this.tap(la, "undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Ib.doOnCompleted = Ib.tapOnCompleted = function(a, b) {
      return this.tap(la, null, "undefined" != typeof b ? function() {
        a.call(b);
      } : a);
    }, Ib["finally"] = function(a) {
      var b = this;
      return new Yc(function(c) {
        var f = d(b.subscribe).call(b, c);
        return f === ta ? (a(), e(f.e)) : rb(function() {
    ...
    var Kc = function(a) {
      ...
      return kb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new c(a));
      }, c.prototype.onNext = la, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
        this.isStopped || (this.isStopped = !0, this.o.onCompleted());
      }, c.prototype.dispose = function() {
    ...
    Ib.ignoreElements = function() {
      ...
      return new Yc(function(b) {
        return a.subscribe(function(a) {
          ...
          b.onNext(Mb(a)), b.onCompleted();
        }, function() {
          b.onNext(Nb()), b.onCompleted();
        });
      }, a);
    }, Ib.repeat = function(a) {
      return Zb(this, a).concat();
    }, Ib.retry = function(a) {
      return Zb(this, a).catchError();
    }, Ib.retryWhen = function(a) {
      return Zb(this).catchErrorWhen(a);
    };
    var Lc = function(a) {
      function b(b, c, d, e) {
    ...
    I.prototype = {
      onNext: function(a) {
        return this.isStopped ? void 0 : (!this.hasValue && (this.hasValue = !0), this.hasAccumulation ? this.accumulation = d(this.accumulator)(this.accumulation, a) : (this.accumulation = this.hasSeed ? d(this.accumulator)(this.seed, a) : a, this.hasAccumulation = !0), this.accumulation === ta ? this.o.onError(this.accumulation.e) : void this.o.onNext(this.accumulation));
      },
      onError: function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      },
      ...
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new Lc(this, c, b, a);
      ...
      var a,
          b = 0;
      arguments.length && Ab(arguments[0]) ? (a = arguments[0], b = 1) : a = Db;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return _b([lc(c, a), this]).concat();
    ...
    }, Ib.flatMapConcat = Ib.concatMap = function(a, b, c) {
      return new Ub(this, a, b, c).merge(1);
    };
    var Mc = function(a) {
      function b(b, c, d) {
      ...
      return kb(b, a), b.prototype.internalMap = function(a, d) {
        ...
        if (!this.isStopped) {
          ...
          return b === ta ? this.o.onError(b.e) : void this.o.onNext(b);
        }
    ...
    }, Ib.flatMap = Ib.selectMany = function(a, b, c) {
      return new Ub(this, a, b, c).mergeAll();
    }, ka.Observable.prototype.flatMapLatest = function(a, b, c) {
      return new Ub(this, a, b, c).switchLatest();
    };
    var Nc = function(a) {
      function b(b, c) {
    ...
    var Oc = function(a) {
      ...
      return kb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          ...
          return b === ta ? this.o.onError(b.e) : void(b && this.o.onNext(a));
        }
      }, e.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, e.prototype.onCompleted = function() {
    ...
    Ib.filter = Ib.where = function(a, b) {
      return this instanceof Oc ? this.internalFilter(a, b) : new Oc(this, a, b);
    }, Sb.fromCallback = function(a, b, c) {
      return function() {
    ...
    }, Sb.fromNodeCallback = function(a, b, c) {
      return function() {
        "undefined" == typeof b && (b = this);
        for (var d = arguments.length,
            e = new Array(d),
    ...
    }, ka.config.useNativeEvents = !1, Sb.fromEvent = function(a, b, c) {
      return a.addListener ? Pc(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : ka.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new Yc(function(e) {
        return U(a, b, function() {
          var a = arguments[0];
          return sa(c) && (a = d(c).apply(null, arguments), a === ta) ? e.onError(a.e) : void e.onNext(a);
        });
      }).publish().refCount() : Pc(function(c) {
        a.on(b, c);
      }, function(c) {
        a.off(b, c);
      }, c);
    };
    var Pc = Sb.fromEventPattern = function(a, b, c, e) {
      return Ab(e) || (e = Db), new Yc(function(e) {
        function f() {
          var a = arguments[0];
          return sa(c) && (a = d(c).apply(null, arguments), a === ta) ? e.onError(a.e) : void e.onNext(a);
        }
        ...
        Rc = Sb.fromPromise = function(a) {
          return new Qc(a);
        };
    Ib.toPromise = function(a) {
      if (a || (a = ka.config.Promise), !a)
        throw new Ca("Promise type not provided nor in Rx.config.Promise");
      var b = this;
      ...
      var c = this;
      return "function" == typeof a ? new Yc(function(d) {
        var e = c.multicast(a());
        return new ob(b(e).subscribe(d), e.connect());
      }, c) : new Sc(c, a);
    }, Ib.publish = function(a) {
      return a && sa(a) ? this.multicast(function() {
        return new _c;
    ...
    var Sc = ka.ConnectableObservable = function(a) {
      function b(b, c) {
        var d,
            e = !1,
            f = b.asObservable();
        this.connect = function() {
          return e || (e = !0, d = new ob(f.subscribe(c), rb(function() {
            e = !1;
          }))), d;
      ...
      return kb(b, a), b.prototype.refCount = function() {
        ...
        Tc = Sb.interval = function(a, b) {
          return Y(a, a, Ab(b) ? b : Jb);
        };
    Sb.timer = function(b, c, d) {
      var e;
      return Ab(d) || (d = Jb), null != c && "number" == typeof c ? e = c : Ab(c) && (d = c), b instanceof Date && e === a ? V(b.getTime(), d) : b instanceof Date && e !== a ? W(b.getTime(), c, d) : e === a ? X(b, d) : Y(b, e, d);
    };
    Ib.delay = function(a, b) {
      return Ab(b) || (b = Jb), a instanceof Date ? $(this, a.getTime(), b) : Z(this, a, b);
    }, Ib.debounce = function(a, b) {
      Ab(b) || (b = Jb);
      var c = this;
      return new Yc(function(d) {
        var e,
      ...
      return Ab(a) || (a = Jb), this.map(function(b) {
        return {
          value: b,
          timestamp: a.now()
        };
      ...
      return Ab(b) || (b = Jb), "number" == typeof a ? _(this, Tc(a, b)) : _(this, a);
    }, Ib.timeout = function(a, b, c) {
      (null == b || "string" == typeof b) && (b = uc(new Error(b || "Timeout"))), Ab(c) || (c = Jb);
      var d = this,
          e = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new Yc(function(f) {
        function g() {
          var d = h;
          l.setDisposable(c[e](a, function() {
            h === d && (ra(b) && (b = Rc(b)), j.setDisposable(b.subscribe(f)));
          }));
        }
        var h = 0,
            i = new vb,
    ...
    var Wc = function(a) {
      ...
      return kb(c, a), c.prototype.request = function(a) {
        ...
        Xc = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new _c, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = null, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || Eb;
          }
          return kb(c, a), lb(c.prototype, Ob, {
            onCompleted: function() {
              this.hasCompleted = !0, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Kb.createOnCompleted()) : (this.subject.onCompleted(), this.disposeCurrentRequest());
            },
            onError: function(a) {
              this.hasFailed = !0, this.error = a, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Kb.createOnError(a)) : (this.subject.onError(a), this.disposeCurrentRequest());
            },
            onNext: function(a) {
              this.requestedCount <= 0 ? this.enableQueue && this.queue.push(Kb.createOnNext(a)) : (0 === this.requestedCount-- && this.disposeCurrentRequest(), this.subject.onNext(a));
            },
            ...
            request: function(a) {
              ...
              return this.requestedDisposable = this.scheduler.scheduleWithState(a, function(a, c) {
                ...
                return !e && d > 0 ? (b.requestedCount = d, rb(function() {
                  b.requestedCount = 0;
                })) : void 0;
    ...
    Ib.controlled = function(a, b) {
      return a && Ab(a) && (b = a, a = !0), null == a && (a = !0), new Wc(this, a, b);
    }, Ib.pipe = function(a) {
      function b() {
        c.resume();
      }
    ...
    var Yc = ka.AnonymousObservable = function(a) {
      function b(a) {
        return a && sa(a.dispose) ? a : sa(a) ? rb(a) : sb;
      }
      function c(a, c) {
    ...
    var _c = ka.Subject = function(a) {
      function c(a) {
        return ub(this), this.isStopped ? this.hasError ? (a.onError(this.error), sb) : (a.onCompleted(), sb) : (this.observers.push(a), new $c(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return kb(d, a), lb(d.prototype, Ob.prototype, {
        hasObservers: function() {
          return this.observers.length > 0;
        },
        onCompleted: function() {
          if (ub(this), !this.isStopped) {
            this.isStopped = !0;
            for (var a = 0,
                c = b(this.observers),
                d = c.length; d > a; a++)
        ...
        ad = ka.AsyncSubject = function(a) {
          function c(a) {
            return ub(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), sb) : (this.observers.push(a), new $c(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return kb(d, a), lb(d.prototype, Ob, {
            hasObservers: function() {
              return ub(this), this.observers.length > 0;
            },
            onCompleted: function() {
              var a,
                  c;
            ...
            onNext: function(a) {
              ub(this), this.isStopped || (this.value = a, this.hasValue = !0);
            },
            dispose: function() {
        ...
        bd = ka.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return kb(c, a), lb(c.prototype, Ob.prototype, {
            onCompleted: function() {
        ...
        cd = ka.BehaviorSubject = function(a) {
          function c(a) {
            return ub(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), sb) : (this.observers.push(a), a.onNext(this.value), new $c(this, a));
          }
          function d(b) {
        ...
        dd = ka.ReplaySubject = function(a) {
          function c(a, b) {
            return rb(function() {
          ...
          function d(a) {
            var b = new ac(this.scheduler, a),
                d = c(this, b);
            ub(this), this._trim(this.scheduler.now()), this.observers.push(b);
            for (var e = 0,
          ...
          function e(b, c, e) {
            this.bufferSize = null == b ? f : b, this.windowSize = null == c ? f : c, this.scheduler = e || Eb, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this, d);
          }
          var f = Math.pow(2, 53) - 1;
          return kb(e, a), lb(e.prototype, Ob.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
    ...
    }(_c), "function" == typeof define && "object" == typeof define.amd && define.amd ? (ja.Rx = ka, define(function() {
      return ka;
    })) : da && ga ? ha ? (ga.exports = ka).Rx = ka : da.Rx = ka : ja.Rx = ka;
    var ed = j();
  }).call(this);
})(require("process"));
