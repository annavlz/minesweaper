...
(function(process) {
  (function(a) {
    ...
    function l(a) {
      ...
      var c = bb.enumPrototypes && "function" == typeof a,
          d = bb.enumErrorProps && (a === Xa || a instanceof Error);
      for (var e in a)
        c && "prototype" == e || d && ("message" == e || "name" == e) || b.push(e);
      if (bb.nonEnumShadows && a !== Ya) {
        var f = a.constructor,
            g = -1,
            h = Ja;
        if (a === (f && f.prototype))
          var i = a === Za ? Ta : a === Xa ? Oa : Ua.call(a),
              j = ab[i];
        for (; ++g < h; )
          e = Ia[g], j && j[e] || !Va.call(a, e) || b.push(e);
      }
      return b;
    }
    function m(a, b, c) {
    ...
    function p(a, b, c, d) {
      ...
      var i = g == La;
      if (!i) {
        if (g != Ra || !bb.nodeClass && (o(a) || o(b)))
          return !1;
        var j = !bb.argsObject && db(a) ? Object : a.constructor,
            k = !bb.argsObject && db(b) ? Object : b.constructor;
        if (!(j == k || Va.call(a, "constructor") && Va.call(b, "constructor") || oa(j) && j instanceof j && oa(k) && k instanceof k || !("constructor" in a && "constructor" in b)))
          return !1;
      }
      c || (c = []), d || (d = []);
      ...
      if (c.push(a), d.push(b), i) {
        ...
        n(b, function(b, e, f) {
          return Va.call(f, e) ? (m++, q = Va.call(a, e) && p(a[e], b, c, d)) : void 0;
        }), q && n(a, function(a, b, c) {
          return Va.call(c, b) ? q = --m > -1 : void 0;
        });
    ...
    function w(b) {
      ...
      if (!d && "string" == typeof b)
        return c = new r(b), c[Ca]();
      if (!d && b.length !== a)
        return c = new t(b), c[Ca]();
      if (!d)
    ...
    function K(a, b, c, d) {
      var e = new Wc;
      return d.push(L(e, b, c)), a.apply(b, d), e.asObservable();
    }
    function L(a, b, c) {
      return function() {
    ...
    function M(a, b, c, d) {
      var e = new Wc;
      return d.push(N(e, b, c)), a.apply(b, d), e.asObservable();
    }
    function N(a, b, c) {
      return function() {
        var e = arguments[0];
 ...
 while (null !== g);
    ...
    function X(a, b) {
      return new Sc(function(c) {
        ...
        return h.setDisposable(a.subscribe(function(a) {
          ...
          f = !0, h.dispose();
        })), new ib(h, b.subscribe(d, function(a) {
          c.onError(a);
        }, d));
      }, a);
    }
    function Y(a, b, c) {
      return new Sc(function(e) {
        function f(a, b) {
    ...
    var Z,
        ...
        _ = $[typeof exports] && exports && !exports.nodeType && exports,
        aa = $[typeof self] && self.Object && self,
        ba = $[typeof window] && window && window.Object && window,
        ca = $[typeof module] && module && !module.nodeType && module,
        da = ca && ca.exports === _ && _,
        ea = _ && ca && "object" == typeof global && global && global.Object && global,
        ...
        oa = ga.helpers.isFunction = function() {
          ...
          return a(/x/) && (a = function(a) {
            return "function" == typeof a && "[object Function]" == Ua.call(a);
          }), a;
        }(),
        pa = {e: {}};
    ...
    var Aa = ga.helpers.notImplemented = function() {
      throw new za;
    },
        Ba = ga.helpers.notSupported = function() {
          throw new ya;
        },
        Ca = "function" == typeof Symbol && Symbol.iterator || "_es6shim_iterator_";
    fa.Set && "function" == typeof(new fa.Set)["@@iterator"] && (Ca = "@@iterator");
    var Da = ga.doneEnumerator = {
      done: !0,
      value: a
    },
        Ea = ga.helpers.isIterable = function(b) {
          return b[Ca] !== a;
        },
        Fa = ga.helpers.isArrayLike = function(b) {
          return b && b.length !== a;
        };
    ga.helpers.iterator = Ca;
    var Ga,
        Ha = ga.internals.bindCallback = function(a, b, c) {
        ...
        Ia = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"],
        Ja = Ia.length,
        Ka = "[object Arguments]",
        La = "[object Array]",
        Ma = "[object Boolean]",
        ...
        Wa = Ua.call(arguments) == Ka,
        Xa = Error.prototype,
        Ya = Object.prototype,
        Za = String.prototype,
        $a = Ya.propertyIsEnumerable;
    try {
      Ga = !(Ua.call(document) == Ra && !({toString: 0} + ""));
    } catch (_a) {
      Ga = !0;
    }
    var ab = {};
    ...
    !function() {
      ...
      for (c in arguments)
        ;
      bb.enumErrorProps = $a.call(Xa, "message") || $a.call(Xa, "name"), bb.enumPrototypes = $a.call(a, "prototype"), bb.nonEnumArgs = 0 != c, bb.nonEnumShadows = !/valueOf/.test(b);
    }(1);
    var cb = ga.internals.isObject = function(a) {
      ...
      return a && ("function" == b || "object" == b) || !1;
        ...
        db = function(a) {
          return a && "object" == typeof a ? Ua.call(a) == Ka : !1;
        };
    Wa || (db = function(a) {
      return a && "object" == typeof a ? Va.call(a, "callee") : !1;
    });
    var eb = ga.internals.isEqual = function(a, b) {
      return p(a, b, [], []);
        ...
        }, ga.CompositeDisposable = function() {
          var a,
              b,
              c = [];
    ...
    var kb = ga.Disposable = function(a) {
    ...
    var lb = kb.create = function(a) {
      return new kb(a);
        ...
        pb = ga.SingleAssignmentDisposable = function() {
          this.isDisposed = !1, this.current = null;
        };
    pb.prototype.getDisposable = function() {
      return this.current;
    }, pb.prototype.setDisposable = function(a) {
      if (this.current)
    ...
    var qb = ga.SerialDisposable = function() {
      this.isDisposed = !1, this.current = null;
    };
    ...
    var rb = (ga.RefCountDisposable = function() {
      function a(a) {
    ...
    }(), ga.internals.ScheduledItem = function(a, b, c, d, e) {
      this.scheduler = a, this.state = b, this.action = c, this.dueTime = d, this.comparer = e || la, this.disposable = new pb;
    });
    ...
    !function(a) {
      function b(a, b) {
        function c(b) {
          function d(a, b) {
            return g ? f.remove(i) : h = !0, e(b, c), mb;
          }
          var g = !1,
              h = !1,
      ...
      function c(a, b, c) {
        function d(b, e) {
          function h(a, b) {
            return i ? g.remove(k) : j = !0, f(b, d), mb;
          }
          var i = !1,
              j = !1,
              k = a[c](b, e, h);
    ...
    var vb,
        wb,
        xb = sb.immediate = function() {
          function a(a, b) {
            return b(this, a);
          }
          return new sb(ja, a, Ba, Ba);
        }(),
        yb = sb.currentThread = function() {
          function a() {
            for (; c.length > 0; ) {
              var a = c.shift();
          ...
          function b(b, f) {
            var g = new rb(this, b, f, this.now());
            if (c)
              c.push(g);
            else {
              c = [g];
        ...
        zb = (ga.internals.SchedulePeriodicRecursive = function() {
          function a(a, b) {
            b(0, this._period);
            try {
    ...
    !function() {
      ...
      var i = RegExp("^" + String(Ua).replace(/[.*+?^${}()|[\]\\]/g, "\\$&").replace(/toString| for [^\]]+/g, ".*?") + "$"),
      ...
      if (oa(j))
        ...
        fa.addEventListener ? fa.addEventListener("message", c, !1) : fa.attachEvent ? fa.attachEvent("onmessage", c) : fa.onmessage = c, vb = function(a) {
          var b = f++;
        ...
        vb = "document" in fa && "onreadystatechange" in fa.document.createElement("script") ? function(b) {
          ...
          var c = f++;
          return g[c] = b, Ab(function() {
            a(c);
          }, 0), c;
        };
    }();
    var Cb,
        Db = sb.timeout = sb["default"] = function() {
          function a(a, b) {
            var c = this,
                d = new pb,
                e = vb(function() {
          ...
          return new sb(ja, a, b, c);
        }(),
        Eb = ga.Notification = function() {
          ...
          return a.prototype.accept = function(a, b, c) {
            ...
            var b = this;
            return ub(a) || (a = xb), new Sc(function(c) {
        ...
        Ib = ga.Observer = function() {},
        Jb = Ib.create = function(a, b, c) {
          return a || (a = ha), b || (b = ma), c || (c = ha), new Lb(a, b, c);
        },
        Kb = ga.internals.AbstractObserver = function(a) {
          function b() {
            this.isStopped = !1;
          }
          return gb(b, a), b.prototype.next = Aa, b.prototype.error = Aa, b.prototype.completed = Aa, b.prototype.onNext = function(a) {
        ...
        Lb = ga.AnonymousObserver = function(a) {
          function b(b, c, d) {
        ...
        Ob = ga.ObservableBase = function(a) {
          function b(a) {
            return a && oa(a.dispose) ? a : oa(a) ? lb(a) : mb;
          }
          function c(a, c) {
            var f = c[0],
                g = c[1],
          ...
          function f(a) {
            var b = new Tc(a),
                d = [b, this];
            return yb.scheduleRequired() ? yb.scheduleWithState(d, c) : c(null, d), b;
          }
          function g() {
            a.call(this, f);
          }
          return gb(g, a), g.prototype.subscribeCore = Aa, g;
        }(Mb),
        Pb = function(a) {
          function b(b, c, d, e) {
        ...
        Qb = ga.internals.Enumerable = function() {},
        Rb = function(a) {
          function b(b) {
          ...
          return gb(b, a), b.prototype.subscribeCore = function(a) {
            var b,
                e = new qb,
                f = xb.scheduleRecursiveWithState(this.sources[Ca](), function(f, g) {
                  if (!b) {
    ...
    var Sb = function(a) {
      ...
      return gb(b, a), b.prototype.subscribeCore = function(a) {
        var b,
            c = this.sources[Ca](),
            e = new qb,
            f = xb.scheduleRecursiveWithState(null, function(f, g) {
              if (!b) {
    ...
    Qb.prototype.catchError = function() {
      return new Sb(this);
    }, Qb.prototype.catchErrorWhen = function(a) {
      var b = this;
      return new Sc(function(c) {
        var e,
            f,
            ...
            k = b[Ca](),
            l = new qb,
            m = xb.scheduleRecursive(function(a) {
              if (!e) {
                ...
                var j = new pb,
                    m = new pb;
                l.setDisposable(new ib(m, j)), j.setDisposable(i.subscribe(function(a) {
                  c.onNext(a);
                }, function(b) {
        ...
        return new ib(j, l, m, lb(function() {
          e = !0;
        }));
      });
    };
    var Tb = function(a) {
      ...
      return gb(b, a), b.prototype[Ca] = function() {
        return new c(this);
      }, c.prototype.next = function() {
        return 0 === this.l ? Da : (this.l > 0 && this.l--, {
          done: !1,
          value: this.v
        });
      }, b;
    }(Qb),
        Ub = Qb.repeat = function(a, b) {
          return new Tb(a, b);
        },
        Vb = function(a) {
          function b(a, b, c) {
            this.s = a, this.fn = b ? Ha(b, c, 3) : null;
          }
          function c(a) {
    ...
    Cb.toArray = function() {
      return new Xb(this);
    }, Mb.create = function(a, b) {
      return new Sc(a, b);
    };
    var Yb = Mb.defer = function(a) {
      return new Sc(function(b) {
        ...
        return na(c) && (c = Lc(c)), c.subscribe(b);
      });
    },
        Zb = function(a) {
          function b(b) {
        ...
        $b = new Zb(xb),
        _b = Mb.empty = function(a) {
          return ub(a) || (a = xb), a === xb ? $b : new Zb(a);
        },
        ac = function(a) {
          function b(b, c, d) {
    ...
    var dc = Mb.from = function(a, b, c, d) {
      if (null == a)
    ...
    var fc = Mb.fromArray = function(a, b) {
    ...
    var mc = function(a) {
      ...
      function d(a, b) {
        var c = b[0],
            d = b[1];
        return d.onNext(c), d.onCompleted(), mb;
      }
      return gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        return this.scheduler === xb ? d(null, a) : this.scheduler.scheduleWithState(a, d);
      }, b;
    }(Ob),
        nc = (Mb["return"] = Mb.just = function(a, b) {
          return ub(b) || (b = xb), new mc(a, b);
        }, function(a) {
          function b(b, c) {
        ...
        oc = Mb["throw"] = function(a, b) {
          return ub(b) || (b = xb), new nc(a, b);
        },
        pc = function(a) {
          function b(b, c, d) {
    ...
    Cb["catch"] = function(a) {
      return oa(a) ? D(this, a) : qc([this, a]);
    };
    var qc = Mb["catch"] = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      return Wb(a).catchError();
    };
    Cb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
    ...
    var rc = Mb.combineLatest = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var d = oa(b[a - 1]) ? b.pop() : F;
      return Array.isArray(b[0]) && (b = b[0]), new Sc(function(a) {
        function c(b) {
        ...
        for (var f = b.length,
          ...
          !function(d) {
            var f = b[d],
                g = new pb;
            na(f) && (f = Lc(f)), g.setDisposable(f.subscribe(function(a) {
              j[d] = a, c(d);
            }, function(b) {
              a.onError(b);
            }, function() {
    ...
    var sc = function(a) {
      ...
      return gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        var a,
            ...
            d = c.length,
            e = this.o,
            f = xb.scheduleRecursiveWithState(0, function(f, g) {
              if (!a) {
                if (f === d)
                  return e.onCompleted();
                var h = c[f];
        ...
        return new ib(b, f, lb(function() {
          a = !0;
        }));
      }, b;
    }(Ob),
        tc = Mb.concat = function() {
          var a;
          if (Array.isArray(arguments[0]))
            a = arguments[0];
          else {
      ...
      return gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        vc = function() {
          ...
          return a.prototype.handleSubscribe = function(a) {
            var c = new pb;
            this.g.add(c), na(a) && (a = Lc(a)), c.setDisposable(a.subscribe(new b(this, c)));
    ...
    var wc = Mb.merge = function() {
      ...
      if (arguments[0])
        ...
        for (a = xb, b = 1; d > b; b++)
          c.push(arguments[b]);
      return Array.isArray(c[0]) && (c = c[0]), A(a, c).mergeAll();
    },
        xc = ga.CompositeError = function(a) {
    ...
    xc.prototype = Error.prototype, Mb.mergeDelayError = function() {
      var a;
      if (Array.isArray(arguments[0]))
        a = arguments[0];
      else {
      ...
      var d = A(null, a);
      return new Sc(function(a) {
        function b() {
          0 === g.length ? a.onCompleted() : 1 === g.length ? a.onError(g[0]) : a.onError(new xc(g));
        }
        var c = new ib,
            e = new pb,
            f = !1,
        ...
        return c.add(e), e.setDisposable(d.subscribe(function(d) {
          var e = new pb;
          c.add(e), na(d) && (d = Lc(d)), e.setDisposable(d.subscribe(function(b) {
            a.onNext(b);
          }, function(a) {
    ...
    var yc = function(a) {
      ...
      return gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new pb;
          this.g.add(b), na(a) && (a = Lc(a)), b.setDisposable(a.subscribe(new d(this, b)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    Cb.mergeAll = function() {
      return new yc(this);
    }, Cb.skipUntil = function(a) {
      var b = this;
      return new Sc(function(c) {
        var d = !1,
    ...
    var zc = function(a) {
      ...
      return gb(b, a), b.prototype.subscribeCore = function(a) {
        ...
        if (!this.isStopped) {
          var b = new pb,
              c = ++this.latest;
          this.hasLatest = !0, this.inner.setDisposable(b), na(a) && (a = Lc(a)), b.setDisposable(a.subscribe(new d(this, c)));
        }
      }, c.prototype.onError = function(a) {
        this.isStopped || (this.isStopped = !0, this.o.onError(a));
      }, c.prototype.onCompleted = function() {
    ...
    Cb["switch"] = Cb.switchLatest = function() {
      return new zc(this);
    };
    var Ac = function(a) {
      function b(b, c) {
        this.source = b, this.other = na(c) ? Lc(c) : c, a.call(this);
      }
      function c(a) {
        this.o = a, this.isStopped = !1;
      }
      return gb(b, a), b.prototype.subscribeCore = function(a) {
        return new ib(this.source.subscribe(a), this.other.subscribe(new c(a)));
      }, c.prototype.onNext = function(a) {
    ...
    Cb.takeUntil = function(a) {
      return new Ac(this, a);
    }, Cb.withLatestFrom = function() {
      for (var a = arguments.length,
          b = new Array(a),
          c = 0; a > c; c++)
        b[c] = arguments[c];
      ...
      return Array.isArray(b[0]) && (b = b[0]), new Sc(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var d = b[c],
                e = new pb;
            na(d) && (d = Lc(d)), e.setDisposable(d.subscribe(function(a) {
      ...
      for (var a = arguments.length,
          ...
          c = 0; a > c; c++)
        b[c] = arguments[c];
      var e = oa(b[a - 1]) ? b.pop() : F;
      Array.isArray(b[0]) && (b = b[0]);
      var f = this;
      return b.unshift(f), new Sc(function(a) {
        for (var c = b.length,
            g = q(c, G),
            h = q(c, E),
            i = new Array(c),
          ...
          !function(c) {
            var j = b[c],
                k = new pb;
            na(j) && (j = Lc(j)), k.setDisposable(j.subscribe(function(b) {
      ...
      return b.unshift(f), new Sc(function(a) {
        for (var c = b.length,
          ...
          !function(c) {
            var j = b[c],
                k = new pb;
            (Fa(j) || Ea(j)) && (j = dc(j)), k.setDisposable(j.subscribe(function(b) {
              if (g[c].push(b), g.every(function(a) {
                return a.length > 0;
              })) {
                var i = g.map(function(a) {
    ...
    }, Cb.asObservable = function() {
      return new Sc(H(this), this);
    }, Cb.dematerialize = function() {
      var a = this;
      return new Sc(function(b) {
    ...
    var Bc = function(a) {
      ...
      return gb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new Cc(a, this.keyFn, this.comparer));
      }, b;
    }(Ob),
        Cc = function(a) {
          function b(b, c, d) {
    ...
    Cb.distinctUntilChanged = function(a, b) {
      return b || (b = ka), new Bc(this, a, b);
    };
    var Dc = function(a) {
      function b(b, c, d, e) {
      ...
      function c(a, b) {
        this.o = a, this.t = !b._oN || oa(b._oN) ? Jb(b._oN || ha, b._oE || ha, b._oC || ha) : b._oN, this.isStopped = !1;
      }
      return gb(b, a), b.prototype.subscribeCore = function(a) {
    ...
    Cb["do"] = Cb.tap = Cb.doAction = function(a, b, c) {
      return new Dc(this, a, b, c);
    }, Cb.doOnNext = Cb.tapOnNext = function(a, b) {
      return this.tap("undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Cb.doOnError = Cb.tapOnError = function(a, b) {
      return this.tap(ha, "undefined" != typeof b ? function(c) {
        a.call(b, c);
      } : a);
    }, Cb.doOnCompleted = Cb.tapOnCompleted = function(a, b) {
      return this.tap(ha, null, "undefined" != typeof b ? function() {
        a.call(b);
      } : a);
    }, Cb["finally"] = function(a) {
      var b = this;
      return new Sc(function(c) {
        var f = d(b.subscribe).call(b, c);
        return f === pa ? (a(), e(f.e)) : lb(function() {
    ...
    Cb.ignoreElements = function() {
      return new Ec(this);
    }, Cb.materialize = function() {
      var a = this;
      return new Sc(function(b) {
        return a.subscribe(function(a) {
          b.onNext(Fb(a));
    ...
    }, Cb.repeat = function(a) {
      return Ub(this, a).concat();
    }, Cb.retry = function(a) {
      return Ub(this, a).catchError();
    }, Cb.retryWhen = function(a) {
      return Ub(this).catchErrorWhen(a);
    };
    var Fc = function(a) {
      function b(b, c, d, e) {
      ...
      return gb(b, a), b.prototype.subscribeCore = function(a) {
        return this.source.subscribe(new I(a, this));
      }, b;
    }(Ob);
    I.prototype = {
      onNext: function(a) {
      ...
      var a,
          b = !1,
          c = arguments[0];
      return 2 === arguments.length && (b = !0, a = arguments[1]), new Fc(this, c, b, a);
    }, Cb.skipLast = function(a) {
      if (0 > a)
        throw new xa;
      var b = this;
      return new Sc(function(c) {
    ...
    }, Cb.startWith = function() {
      var a,
          b = 0;
      arguments.length && ub(arguments[0]) ? (a = arguments[0], b = 1) : a = xb;
      for (var c = [],
          d = b,
          e = arguments.length; e > d; d++)
        c.push(arguments[d]);
      return Wb([fc(c, a), this]).concat();
    }, Cb.takeLast = function(a) {
      if (0 > a)
        throw new xa;
      var b = this;
      return new Sc(function(c) {
    ...
    }, Cb.flatMapConcat = Cb.concatMap = function(a, b, c) {
      return new Pb(this, a, b, c).merge(1);
    };
    var Gc = function(a) {
      function b(b, c, d) {
        this.source = b, this.selector = Ha(c, d, 3), a.call(this);
      }
      function c(a, b) {
        return function(c, d, e) {
    ...
    Cb.map = Cb.select = function(a, b) {
      var c = "function" == typeof a ? a : function() {
        return a;
      };
      return this instanceof Gc ? this.internalMap(c, b) : new Gc(this, c, b);
    }, Cb.pluck = function() {
      ...
      for (var c = 0; a > c; c++)
        b[c] = arguments[c];
      return this.map(J(b, a));
    }, Cb.flatMap = Cb.selectMany = function(a, b, c) {
      return new Pb(this, a, b, c).mergeAll();
    }, ga.Observable.prototype.flatMapLatest = function(a, b, c) {
      return new Pb(this, a, b, c).switchLatest();
    };
    var Hc = function(a) {
      function b(b, c) {
    ...
    var Ic = function(a) {
      function b(b, c, d) {
        this.source = b, this.predicate = Ha(c, d, 3), a.call(this);
      }
      function c(a, b) {
        return function(c, d, e) {
    ...
    Cb.filter = Cb.where = function(a, b) {
      return this instanceof Ic ? this.internalFilter(a, b) : new Ic(this, a, b);
    ...
    }, ga.config.useNativeEvents = !1, Mb.fromEvent = function(a, b, c) {
      return a.addListener ? Jc(function(c) {
        a.addListener(b, c);
      }, function(c) {
        a.removeListener(b, c);
      }, c) : ga.config.useNativeEvents || "function" != typeof a.on || "function" != typeof a.off ? new Sc(function(d) {
        return P(a, b, Q(d, c));
      }).publish().refCount() : Jc(function(c) {
        a.on(b, c);
      }, function(c) {
        a.off(b, c);
      }, c);
    };
    var Jc = Mb.fromEventPattern = function(a, b, c, e) {
      return ub(e) || (e = xb), new Sc(function(e) {
        function f() {
          var a = arguments[0];
        ...
        Lc = Mb.fromPromise = function(a) {
          return new Kc(a);
        };
    Cb.toPromise = function(a) {
      ...
      return Lc(b);
    }, Cb.multicast = function(a, b) {
      var c = this;
      return "function" == typeof a ? new Sc(function(d) {
        var e = c.multicast(a());
        return new ib(b(e).subscribe(d), e.connect());
      }, c) : new Mc(c, a);
    }, Cb.publish = function(a) {
      return a && oa(a) ? this.multicast(function() {
        return new Vc;
      }, a) : this.multicast(new Vc);
    }, Cb.share = function() {
      return this.publish().refCount();
    }, Cb.publishLast = function(a) {
      return a && oa(a) ? this.multicast(function() {
        return new Wc;
      }, a) : this.multicast(new Wc);
    }, Cb.publishValue = function(a, b) {
      return 2 === arguments.length ? this.multicast(function() {
        return new Yc(b);
      }, a) : this.multicast(new Yc(a));
    }, Cb.shareValue = function(a) {
      return this.publishValue(a).refCount();
    }, Cb.replay = function(a, b, c, d) {
      return a && oa(a) ? this.multicast(function() {
        return new Zc(b, c, d);
      }, a) : this.multicast(new Zc(b, c, d));
    }, Cb.shareReplay = function(a, b, c) {
      return this.replay(null, a, b, c).refCount();
    };
    var Mc = ga.ConnectableObservable = function(a) {
      function b(b, c) {
        var d,
            e = !1,
            f = b.asObservable();
      ...
      return gb(b, a), b.prototype.refCount = function() {
        ...
        Nc = Mb.interval = function(a, b) {
          return U(a, a, ub(b) ? b : Db);
        };
    Mb.timer = function(b, c, d) {
      var e;
      return ub(d) || (d = Db), null != c && "number" == typeof c ? e = c : ub(c) && (d = c), b instanceof Date && e === a ? R(b.getTime(), d) : b instanceof Date && e !== a ? S(b.getTime(), c, d) : e === a ? T(b, d) : U(b, e, d);
    };
    Cb.delay = function(a, b) {
      return ub(b) || (b = Db), a instanceof Date ? W(this, a.getTime(), b) : V(this, a, b);
    }, Cb.debounce = function(a, b) {
      ub(b) || (b = Db);
      var c = this;
      return new Sc(function(d) {
        var e,
    ...
    }, Cb.throttle = function(a, b) {
      return this.debounce(a, b);
    }, Cb.timestamp = function(a) {
      return ub(a) || (a = Db), this.map(function(b) {
        return {
          value: b,
          timestamp: a.now()
        };
      });
    }, Cb.sample = Cb.throttleLatest = function(a, b) {
      return ub(b) || (b = Db), "number" == typeof a ? X(this, Nc(a, b)) : X(this, a);
    }, Cb.timeout = function(a, b, c) {
      (null == b || "string" == typeof b) && (b = oc(new Error(b || "Timeout"))), ub(c) || (c = Db);
      var d = this,
          e = a instanceof Date ? "scheduleWithAbsolute" : "scheduleWithRelative";
      return new Sc(function(f) {
        function g() {
          var d = h;
          l.setDisposable(c[e](a, function() {
            h === d && (na(b) && (b = Lc(b)), j.setDisposable(b.subscribe(f)));
          }));
        }
        var h = 0,
            i = new pb,
    ...
    var Oc = function(a) {
      ...
      function c(c, d) {
        this.source = c, this.controller = new Vc, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, a.call(this, b, c);
      }
    ...
    var Pc = function(b) {
      function c(b) {
        ...
        var d,
            e = [],
            f = Y(this.source, this.pauser.startWith(!1).distinctUntilChanged(), function(a, b) {
              return {
                data: a,
                shouldFire: b
              };
      ...
      function d(a, d) {
        this.source = a, this.controller = new Vc, d && d.subscribe ? this.pauser = this.controller.merge(d) : this.pauser = this.controller, b.call(this, c, a);
      }
    ...
    Cb.pausableBuffered = function(a) {
    ...
    var Qc = function(a) {
      ...
      function c(c, d, e) {
        a.call(this, b, c), this.subject = new Rc(d, e), this.source = c.multicast(this.subject).refCount();
      }
      return gb(c, a), c.prototype.request = function(a) {
        ...
        Rc = function(a) {
          ...
          function c(c, d) {
            null == c && (c = !0), a.call(this, b), this.subject = new Vc, this.enableQueue = c, this.queue = c ? [] : null, this.requestedCount = 0, this.requestedDisposable = null, this.error = null, this.hasFailed = !1, this.hasCompleted = !1, this.scheduler = d || yb;
          }
          return gb(c, a), hb(c.prototype, Ib, {
            onCompleted: function() {
              this.hasCompleted = !0, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Eb.createOnCompleted()) : (this.subject.onCompleted(), this.disposeCurrentRequest());
            },
            onError: function(a) {
              this.hasFailed = !0, this.error = a, this.enableQueue && 0 !== this.queue.length ? this.queue.push(Eb.createOnError(a)) : (this.subject.onError(a), this.disposeCurrentRequest());
            },
            onNext: function(a) {
              this.requestedCount <= 0 ? this.enableQueue && this.queue.push(Eb.createOnNext(a)) : (0 === this.requestedCount-- && this.disposeCurrentRequest(), this.subject.onNext(a));
            },
            ...
            request: function(a) {
              ...
              return this.requestedDisposable = this.scheduler.scheduleWithState(a, function(a, c) {
                ...
                return !e && d > 0 ? (b.requestedCount = d, lb(function() {
                  b.requestedCount = 0;
                })) : void 0;
    ...
    Cb.controlled = function(a, b) {
      return a && ub(a) && (b = a, a = !0), null == a && (a = !0), new Qc(this, a, b);
    }, Cb.pipe = function(a) {
      function b() {
        c.resume();
      }
    ...
    var Sc = ga.AnonymousObservable = function(a) {
      function b(a) {
        return a && oa(a.dispose) ? a : oa(a) ? lb(a) : mb;
      }
      function c(a, c) {
    ...
    var Vc = ga.Subject = function(a) {
      function c(a) {
        return ob(this), this.isStopped ? this.hasError ? (a.onError(this.error), mb) : (a.onCompleted(), mb) : (this.observers.push(a), new Uc(this, a));
      }
      function d() {
        a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.observers = [], this.hasError = !1;
      }
      return gb(d, a), hb(d.prototype, Ib.prototype, {
        ...
        Wc = ga.AsyncSubject = function(a) {
          function c(a) {
            return ob(this), this.isStopped ? (this.hasError ? a.onError(this.error) : this.hasValue ? (a.onNext(this.value), a.onCompleted()) : a.onCompleted(), mb) : (this.observers.push(a), new Uc(this, a));
          }
          function d() {
            a.call(this, c), this.isDisposed = !1, this.isStopped = !1, this.hasValue = !1, this.observers = [], this.hasError = !1;
          }
          return gb(d, a), hb(d.prototype, Ib, {
            hasObservers: function() {
        ...
        Xc = ga.AnonymousSubject = function(a) {
          function b(a) {
          ...
          return gb(c, a), hb(c.prototype, Ib.prototype, {
            onCompleted: function() {
        ...
        Yc = ga.BehaviorSubject = function(a) {
          function c(a) {
            return ob(this), this.isStopped ? (this.hasError ? a.onError(this.error) : a.onCompleted(), mb) : (this.observers.push(a), a.onNext(this.value), new Uc(this, a));
          }
          function d(b) {
        ...
        Zc = ga.ReplaySubject = function(a) {
          function c(a, b) {
            return lb(function() {
          ...
          function e(b, c, e) {
            this.bufferSize = null == b ? f : b, this.windowSize = null == c ? f : c, this.scheduler = e || yb, this.q = [], this.observers = [], this.isStopped = !1, this.isDisposed = !1, this.hasError = !1, this.error = null, a.call(this, d);
          }
          var f = Math.pow(2, 53) - 1;
          return gb(e, a), hb(e.prototype, Ib.prototype, {
            hasObservers: function() {
              return this.observers.length > 0;
            },
            _trim: function(a) {
    ...
    }(Vc), "function" == typeof define && "object" == typeof define.amd && define.amd ? (fa.Rx = ga, define(function() {
      return ga;
    })) : _ && ca ? da ? (ca.exports = ga).Rx = ga : _.Rx = ga : fa.Rx = ga;
    var $c = j();
  }).call(this);
})(require("process"));
